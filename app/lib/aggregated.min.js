(function() {
    function a(a, b) {
        if (a !== b) {
            var c = null === a, d = a === v, e = a === a, f = null === b, g = b === v, h = b === b;
    ...
    function p(a, b) {
        for (var c = -1, d = a.length, e = -1, f = []; ++c < d; ) a[c] === b && (a[c] = O, 
        f[++e] = c);
        return f;
    }
    function q(a, b) {
    ...
    function u(o) {
        function V(a) {
            if (n(a) && !Ai(a) && !(a instanceof Qb)) {
                if (a instanceof _) return a;
                if (Wg.call(a, "__chain__") && Wg.call(a, "__wrapped__")) return ie(a);
            }
            return new _(a);
        }
        function Z() {}
        ...
        function Qb(a) {
            ...
            this.__filtered__ = !1, this.__iteratees__ = null, this.__takeCount__ = yh, this.__views__ = null;
        }
        function Rb() {
            var a = this.__actions__, b = this.__iteratees__, c = this.__views__, d = new Qb(this.__wrapped__);
            return d.__actions__ = a ? cc(a) : null, d.__dir__ = this.__dir__, d.__filtered__ = this.__filtered__, 
            d.__iteratees__ = b ? cc(b) : null, d.__takeCount__ = this.__takeCount__, d.__views__ = c ? cc(c) : null, 
            d;
        }
        function Sb() {
        ...
        function Tb() {
            ...
            if (!Ai(a)) return bd(a, this.__actions__);
            var b = this.__dir__, c = 0 > b, d = Pd(0, a.length, this.__views__), e = d.start, f = d.end, g = f - e, h = c ? f : e - 1, i = sh(g, this.__takeCount__), j = this.__iteratees__, k = j ? j.length : 0, l = 0, m = [];
            a: for (;g-- && i > l; ) {
                h += b;
        ...
        function Xb(a) {
            return "__proto__" != a && Wg.call(this.__data__, a);
        }
        function Yb(a, b) {
        ...
        function ic(a, b) {
            for (var c = -1, d = a.length, e = Hg(d); ++c < d; ) e[c] = b(a[c], c, a);
            return e;
        }
        function jc(a, b, c, d) {
            var e = -1, f = a.length;
        ...
        function oc(a, b, c, d) {
            return a !== v && Wg.call(d, c) ? a : b;
        }
        function pc(a, b, c) {
            for (var d = -1, e = Mi(b), f = e.length; ++d < f; ) {
                var g = e[d], h = a[g], i = c(h, b[g], g, a, b);
                (i === i ? i === h : h !== h) && (h !== v || g in a) || (a[g] = i);
            }
            return a;
        }
        function qc(a, b) {
            return null == b ? a : sc(b, Mi(b), a);
        }
        function rc(a, b) {
            for (var c = -1, d = null == a, e = !d && Ud(a), f = e ? a.length : 0, g = b.length, h = Hg(g); ++c < g; ) {
                var i = b[c];
                h[c] = e ? Vd(i, f) ? a[i] : v : d ? v : a[i];
            }
            return h;
        }
        function sc(a, b, c) {
        ...
        function tc(a, b, c) {
            var d = typeof a;
            return "function" == d ? b === v ? a : ed(a, b, c) : null == a ? ug : "object" == d ? Mc(a) : b === v ? Ag(a) : Nc(a, b);
        }
        function uc(a, b, c, d, e, f, g) {
            var h;
            if (c && (h = e ? c(a, d, e) : c(a)), h !== v) return h;
            if (!Cf(a)) return a;
            var i = Ai(a);
            if (i) {
                if (h = Qd(a), !b) return cc(a, h);
            } else {
                var j = Yg.call(a), k = j == U;
                if (j != X && j != P && (!k || e)) return Ob[j] ? Sd(a, j, b) : e ? a : {};
                if (h = Rd(k ? {} : a), !b) return qc(h, a);
            }
            f || (f = []), g || (g = []);
            for (var l = f.length; l--; ) if (f[l] == a) return g[l];
            return f.push(a), g.push(h), (i ? dc : Ec)(a, function(d, e) {
                h[e] = uc(d, b, c, e, a, f, g);
            }), h;
        }
        function vc(a, b, c) {
            if ("function" != typeof a) throw new Qg(N);
            return ih(function() {
                a.apply(v, c);
            }, b);
        }
        function wc(a, b) {
            ...
            if (!d) return e;
            var f = -1, g = Md(), h = g == c, i = h && b.length >= 200 ? Nh(b) : null, j = b.length;
            i && (g = $b, h = !1, b = i);
            a: for (;++f < d; ) {
                var k = a[f];
                if (h && k === k) {
        ...
        function xc(a, b) {
            var c = !0;
            return Ih(a, function(a, d, e) {
                return c = !!b(a, d, e);
            }), c;
        }
        function yc(a, b, c, d) {
            var e = d, f = e;
            return Ih(a, function(a, g, h) {
                var i = +b(a, g, h);
        ...
        function zc(a, b, c, d) {
            var e = a.length;
            for (c = null == c ? 0 : +c || 0, 0 > c && (c = -c > e ? 0 : e + c), d = d === v || d > e ? e : +d || 0, 
        ...
        function Ic(a, b, c, d, e, f) {
            return a === b ? !0 : null == a || null == b || !Cf(a) && !n(b) ? a !== a && b !== b : Jc(a, b, Ic, c, d, e, f);
        }
        function Jc(a, b, c, d, e, f, g) {
            var h = Ai(a), i = Ai(b), j = Q, k = Q;
            h || (j = Yg.call(a), j == P ? j = X : j != X && (h = Kf(a))), i || (k = Yg.call(b), 
            k == P ? k = X : k != X && (i = Kf(b)));
            var l = j == X, m = k == X, n = j == k;
            if (n && !h && !l) return Id(a, b, j);
            if (!e) {
                var o = l && Wg.call(a, "__wrapped__"), p = m && Wg.call(b, "__wrapped__");
        ...
        function Kc(a, b, c) {
            ...
            for (;++d < e; ) {
                ...
                if (f && g[2]) {
                    if (i === v && !(h in a)) return !1;
                } else {
                    var k = c ? c(i, j, h) : v;
                    if (!(k === v ? Ic(j, i, c, !0) : k)) return !1;
                }
            }
            return !0;
        }
        function Lc(a, b) {
            var c = -1, d = Ud(a) ? Hg(a.length) : [];
            return Ih(a, function(a, e, f) {
                d[++c] = b(a, e, f);
            }), d;
        }
        function Mc(a) {
            ...
            if (1 == b.length && b[0][2]) {
                var c = b[0][0], d = b[0][1];
                return function(a) {
                    return null == a ? !1 : a[c] === d && (d !== v || c in ge(a));
                };
            }
            return function(a) {
                return Kc(a, b);
        ...
        function Nc(a, b) {
            var c = Ai(a), d = Xd(a) && $d(b), e = a + "";
            return a = he(a), function(f) {
                if (null == f) return !1;
                var g = e;
                if (f = ge(f), !(!c && d || g in f)) {
                    if (f = 1 == a.length ? f : Hc(f, Vc(a, 0, -1)), null == f) return !1;
                    g = ve(a), f = ge(f);
                }
                return f[g] === b ? b !== v || g in f : Ic(b, f[g], v, !0);
            };
        }
        function Oc(a, b, c, d, e) {
            if (!Cf(a)) return a;
            var f = Ud(b) && (Ai(b) || Kf(b)), g = f ? null : Mi(b);
            return dc(g || b, function(h, i) {
                if (g && (i = h, h = b[i]), n(h)) d || (d = []), e || (e = []), Pc(a, b, i, Oc, c, d, e); else {
                    var j = a[i], k = c ? c(j, h, i, a, b) : v, l = k === v;
                    l && (k = h), k === v && (!f || i in a) || !l && (k === k ? k === j : j !== j) || (a[i] = k);
                }
            }), a;
        }
        function Pc(a, b, c, d, e, f, g) {
            for (var h = f.length, i = b[c]; h--; ) if (f[h] == i) return void (a[c] = g[h]);
            var j = a[c], k = e ? e(j, i, c, a, b) : v, l = k === v;
            l && (k = i, Ud(i) && (Ai(i) || Kf(i)) ? k = Ai(j) ? j : Ud(j) ? cc(j) : [] : Di(i) || vf(i) ? k = vf(j) ? Pf(j) : Di(j) ? j : {} : l = !1), 
        ...
        function Vc(a, b, c) {
            var d = -1, e = a.length;
            b = null == b ? 0 : +b || 0, 0 > b && (b = -b > e ? 0 : e + b), c = c === v || c > e ? e : +c || 0, 
            0 > c && (c += e), e = b > c ? 0 : c - b >>> 0, b >>>= 0;
            for (var f = Hg(e); ++d < e; ) f[d] = a[d + b];
            return f;
        }
        function Wc(a, b) {
            var c;
        ...
        function $c(a, b) {
            var d = -1, e = Md(), f = a.length, g = e == c, h = g && f >= 200, i = h ? Nh() : null, j = [];
            i ? (e = $b, g = !1) : (h = !1, i = b ? [] : j);
            a: for (;++d < f; ) {
        ...
        function _c(a, b) {
            for (var c = -1, d = b.length, e = Hg(d); ++c < d; ) e[c] = a[b[c]];
            return e;
        }
        function ad(a, b, c, d) {
            for (var e = a.length, f = d ? e : -1; (d ? f-- : ++f < e) && b(a[f], f, a); ) ;
            return c ? Vc(a, d ? 0 : f, d ? f + 1 : e) : Vc(a, d ? f + 1 : 0, d ? e : f);
        }
        function bd(a, b) {
            var c = a;
            c instanceof Qb && (c = c.value());
            for (var d = -1, e = b.length; ++d < e; ) {
                var f = [ c ], g = b[d];
                gh.apply(f, g.args), c = g.func.apply(g.thisArg, f);
            }
            return c;
        }
        function cd(a, b, c) {
            var d = 0, e = a ? a.length : d;
            if ("number" == typeof b && b === b && Bh >= e) {
                for (;e > d; ) {
                    var f = d + e >>> 1, g = a[f];
        ...
        function dd(a, b, c, d) {
            b = c(b);
            for (var e = 0, f = a ? a.length : 0, g = b !== b, h = null === b, i = b === v; f > e; ) {
                var j = dh((e + f) / 2), k = c(a[j]), l = k !== v, m = k === k;
        ...
        function ed(a, b, c) {
            if ("function" != typeof a) return ug;
            if (b === v) return a;
            switch (c) {
              case 1:
                return function(c) {
        ...
        function gd(a, b, c) {
            for (var d = c.length, e = -1, f = rh(a.length - d, 0), g = -1, h = b.length, i = Hg(f + h); ++g < h; ) i[g] = b[g];
            for (;++e < d; ) i[c[e]] = a[e];
            for (;f--; ) i[g++] = a[e++];
            return i;
        }
        function hd(a, b, c) {
            for (var d = -1, e = c.length, f = -1, g = rh(a.length - e, 0), h = -1, i = b.length, j = Hg(g + i); ++f < g; ) j[f] = a[f];
        ...
        function id(a, b) {
            return function(c, d, e) {
                var f = b ? b() : {};
                if (d = Kd(d, e, 3), Ai(c)) for (var g = -1, h = c.length; ++g < h; ) {
                    var i = c[g];
                    a(f, i, d(i, g, c), c);
                } else Ih(c, function(b, c, e) {
                    a(f, b, d(b, c, e), e);
                });
                return f;
            };
        ...
        function jd(a) {
            return nf(function(b, c) {
                var d = -1, e = null == b ? 0 : c.length, f = e > 2 ? c[e - 2] : v, g = e > 2 ? c[2] : v, h = e > 1 ? c[e - 1] : v;
                for ("function" == typeof f ? (f = ed(f, h, 5), e -= 2) : (f = "function" == typeof h ? h : v, 
                e -= f ? 1 : 0), g && Wd(c[0], c[1], g) && (f = 3 > e ? v : f, e = 1); ++d < e; ) {
                    var i = c[d];
                    i && a(b, i, f);
                }
                return b;
        ...
        function kd(a, b) {
            return function(c, d) {
                var e = c ? Ph(c) : 0;
                if (!Zd(e)) return a(c, d);
                for (var f = b ? e : -1, g = ge(c); (b ? f-- : ++f < e) && d(g[f], f, g) !== !1; ) ;
                return c;
            };
        }
        function ld(a) {
            return function(b, c, d) {
                for (var e = ge(b), f = d(b), g = f.length, h = a ? g : -1; a ? h-- : ++h < g; ) {
                    var i = f[h];
        ...
        function md(a, b) {
            function c() {
                var e = this && this !== _b && this instanceof c ? d : a;
        ...
        function nd(a) {
            return function(b) {
                for (var c = -1, d = rg(dg(b)), e = d.length, f = ""; ++c < e; ) f = a(f, d[c], c);
                return f;
            };
        }
        function od(a) {
            return function() {
                ...
                var c = Hh(a.prototype), d = a.apply(c, b);
                return Cf(d) ? d : c;
            };
        }
        function pd(a) {
            function b(c, d, e) {
                e && Wd(c, d, e) && (d = null);
                var f = Gd(c, a, null, null, null, null, null, d);
        ...
        function qd(a, b) {
            return function(c, d, e) {
                if (e && Wd(c, d, e) && (d = null), d = Kd(d, e, 3), 1 == d.length) {
                    c = fe(c);
                    var f = gc(c, d, a, b);
        ...
        function sd(a) {
            return function(c, d, e) {
                return c && c.length ? (d = Kd(d, e, 3), b(c, d, a)) : -1;
            };
        }
        function td(a) {
            return function(b, c, d) {
                return c = Kd(c, d, 3), Bc(b, c, a, !0);
            };
        }
        function ud(a) {
            return function() {
                for (var b, c = arguments.length, d = a ? c : -1, e = 0, f = Hg(c); a ? d-- : ++d < c; ) {
                    var g = f[e++] = arguments[d];
                    if ("function" != typeof g) throw new Qg(N);
                    !b && _.prototype.thru && "wrapper" == Ld(g) && (b = new _([]));
                }
                for (d = b ? -1 : c; ++d < c; ) {
                    g = f[d];
                    var h = Ld(g), i = "wrapper" == h ? Oh(g) : null;
                    b = i && Yd(i[0]) && i[1] == (E | A | C | F) && !i[4].length && 1 == i[9] ? b[Ld(i[0])].apply(b, i[3]) : 1 == g.length && Yd(g) ? b[h]() : b.thru(g);
                }
                return function() {
                    var a = arguments;
                    if (b && 1 == a.length && Ai(a[0])) return b.plant(a[0]).value();
                    for (var d = 0, e = c ? f[d].apply(this, a) : a[0]; ++d < c; ) e = f[d].call(this, e);
                    return e;
                };
            };
        }
        function vd(a, b) {
            return function(c, d, e) {
                return "function" == typeof d && e === v && Ai(c) ? a(c, d) : b(c, ed(d, e, 3));
            };
        }
        function wd(a) {
            return function(b, c, d) {
                return ("function" != typeof c || d !== v) && (c = ed(c, d, 3)), a(b, c, Vf);
            };
        }
        function xd(a) {
            return function(b, c, d) {
                return ("function" != typeof c || d !== v) && (c = ed(c, d, 3)), a(b, c);
            };
        }
        function yd(a) {
            return function(b, c, d) {
                var e = {};
                return c = Kd(c, d, 3), Ec(b, function(b, d, f) {
                    var g = c(b, d, f);
        ...
        function zd(a) {
            return function(b, c, d) {
                return b = e(b), (a ? b : "") + Dd(b, c, d) + (a ? "" : b);
            };
        }
        function Ad(a) {
            var b = nf(function(c, d) {
                var e = p(d, b.placeholder);
                return Gd(c, a, null, d, e);
            });
            return b;
        }
        function Bd(a, b) {
            return function(c, d, e, f) {
                ...
                return "function" == typeof d && f === v && Ai(c) ? a(c, d, e, g) : Uc(c, Kd(d, f, 4), e, g, b);
            };
        }
        function Cd(a, b, c, d, e, f, g, h, i, j) {
            function k() {
                for (var t = arguments.length, u = t, w = Hg(t); u--; ) w[u] = arguments[u];
                if (d && (w = gd(w, d, e)), f && (w = hd(w, f, g)), o || r) {
                    var z = k.placeholder, A = p(w, z);
                    if (t -= A.length, j > t) {
                        var B = h ? cc(h) : null, E = rh(j - t, 0), F = o ? A : null, G = o ? null : A, H = o ? w : null, I = o ? null : w;
                        b |= o ? C : D, b &= ~(o ? D : C), q || (b &= ~(x | y));
                        var J = [ a, b, c, H, F, I, G, B, i, E ], K = Cd.apply(v, J);
                        return Yd(a) && Qh(K, J), K.placeholder = z, K;
                    }
                }
                var L = m ? c : this, M = n ? L[a] : a;
                return h && (w = ce(w, h)), l && i < w.length && (w.length = i), this && this !== _b && this instanceof k && (M = s || od(a)), 
                M.apply(L, w);
            }
            var l = b & E, m = b & x, n = b & y, o = b & A, q = b & z, r = b & B, s = n ? null : od(a);
            return k;
        }
        function Dd(a, b, c) {
            var d = a.length;
            if (b = +b, d >= b || !ph(b)) return "";
            var e = b - d;
            return c = null == c ? " " : c + "", jg(c, bh(e / c.length)).slice(0, e);
        }
        function Ed(a, b, c, d) {
            function e() {
                for (var b = -1, h = arguments.length, i = -1, j = d.length, k = Hg(h + j); ++i < j; ) k[i] = d[i];
                for (;h--; ) k[i++] = arguments[++b];
                var l = this && this !== _b && this instanceof e ? g : a;
        ...
        function Fd(a) {
            return function(b, c, d, e) {
                var f = Kd(d);
                return null == d && f === tc ? cd(b, c, a) : dd(b, c, f(d, e, 1), a);
            };
        }
        function Gd(a, b, c, d, e, f, g, h) {
            var i = b & y;
            if (!i && "function" != typeof a) throw new Qg(N);
            var j = d ? d.length : 0;
            if (j || (b &= ~(C | D), d = e = null), j -= e ? e.length : 0, b & D) {
                var k = d, l = e;
                d = e = null;
            }
            var m = i ? null : Oh(a), n = [ a, b, c, d, e, k, l, f, g, h ];
            if (m && (_d(n, m), b = n[1], h = n[9]), n[9] = null == h ? i ? 0 : a.length : rh(h - j, 0) || 0, 
            b == x) var o = md(n[0], n[2]); else o = b != C && b != (x | C) || n[4].length ? Cd.apply(v, n) : Ed.apply(v, n);
            var p = m ? Mh : Qh;
            return p(o, n);
        }
        function Hd(a, b, c, d, e, f, g) {
            ...
            for (;++h < i; ) {
                var k = a[h], l = b[h], m = d ? d(e ? l : k, e ? k : l, h) : v;
                if (m !== v) {
                    if (m) continue;
                    return !1;
                }
        ...
        function Jd(a, b, c, d, e, f, g) {
            var h = Mi(a), i = h.length, j = Mi(b), k = j.length;
            if (i != k && !e) return !1;
            for (var l = i; l--; ) {
                var m = h[l];
                if (!(e ? m in b : Wg.call(b, m))) return !1;
            }
            for (var n = e; ++l < i; ) {
                m = h[l];
                var o = a[m], p = b[m], q = d ? d(e ? p : o, e ? o : p, m) : v;
                if (!(q === v ? c(o, p, d, e, f, g) : q)) return !1;
                n || (n = "constructor" == m);
            }
            if (!n) {
        ...
        function Kd(a, b, c) {
            var d = V.callback || sg;
            return d = d === sg ? tc : d, c ? d(a, b, c) : d;
        }
        function Ld(a) {
            for (var b = a.name, c = Fh[b], d = c ? c.length : 0; d--; ) {
                var e = c[d], f = e.func;
        ...
        function Md(a, b, d) {
            var e = V.indexOf || te;
            return e = e === te ? c : e, a ? e(a, b, d) : e;
        }
        function Nd(a) {
            for (var b = Wf(a), c = b.length; c--; ) b[c][2] = $d(b[c][1]);
            return b;
        }
        function Od(a, b) {
            var c = null == a ? v : a[b];
        ...
        function Qd(a) {
            ...
            return b && "string" == typeof a[0] && Wg.call(a, "index") && (c.index = a.index, 
            c.input = a.input), c;
        }
        function Rd(a) {
            var b = a.constructor;
            return "function" == typeof b && b instanceof b || (b = Ng), new b();
        }
        function Sd(a, b, c) {
            var d = a.constructor;
            switch (b) {
              ...
              case jb:
                var e = a.buffer;
                return new d(c ? fd(e) : e, a.byteOffset, a.length);
              ...
              case Y:
                var f = new d(a.source, Cb.exec(a));
                f.lastIndex = a.lastIndex;
            }
            return f;
        }
        function Td(a, b, c) {
            null == a || Xd(b, a) || (b = he(b), a = 1 == b.length ? a : Hc(a, Vc(b, 0, -1)), 
            b = ve(b));
            var d = null == a ? a : a[b];
            return null == d ? v : d.apply(a, c);
        }
        function Ud(a) {
            return null != a && Zd(Ph(a));
        }
        function Vd(a, b) {
            return a = "number" == typeof a || Fb.test(a) ? +a : -1, b = null == b ? Dh : b, 
            a > -1 && a % 1 == 0 && b > a;
        }
        function Wd(a, b, c) {
            if (!Cf(c)) return !1;
            var d = typeof b;
            if ("number" == d ? Ud(c) && Vd(b, c.length) : "string" == d && b in c) {
                var e = c[b];
                return a === a ? a === e : e !== e;
            }
            return !1;
        ...
        function Xd(a, b) {
            var c = typeof a;
            if ("string" == c && vb.test(a) || "number" == c) return !0;
            if (Ai(a)) return !1;
            var d = !ub.test(a);
            return d || null != b && a in ge(b);
        }
        function Yd(a) {
            var b = Ld(a);
            if (!(b in Qb.prototype)) return !1;
            var c = V[b];
            if (a === c) return !0;
            var d = Oh(c);
            return !!d && a === d[0];
        ...
        function Zd(a) {
            return "number" == typeof a && a > -1 && a % 1 == 0 && Dh >= a;
        }
        function $d(a) {
            return a === a && !Cf(a);
        }
        function _d(a, b) {
            var c = a[1], d = b[1], e = c | d, f = E > e, g = d == E && c == A || d == E && c == F && a[7].length <= b[8] || d == (E | F) && c == A;
            if (!f && !g) return a;
            d & x && (a[2] = b[2], e |= c & x ? 0 : z);
            var h = b[3];
            if (h) {
                var i = a[3];
                a[3] = i ? gd(i, h, b[4]) : cc(h), a[4] = i ? p(a[3], O) : cc(b[4]);
            }
            return h = b[5], h && (i = a[5], a[5] = i ? hd(i, h, b[6]) : cc(h), a[6] = i ? p(a[5], O) : cc(b[6])), 
            h = b[7], h && (a[7] = cc(h)), d & E && (a[8] = null == a[8] ? b[8] : sh(a[8], b[8])), 
        ...
        function ce(a, b) {
            for (var c = a.length, d = sh(b.length, c), e = cc(a); d--; ) {
                var f = b[d];
                a[d] = Vd(f, c) ? e[f] : v;
            }
            return a;
        ...
        function de(a) {
            ...
            if (!n(a) || Yg.call(a) != X || !Wg.call(a, "constructor") && (b = a.constructor, 
        ...
        function ee(a) {
            for (var b = Vf(a), c = b.length, d = c && a.length, e = !!d && Zd(d) && (Ai(a) || vf(a)), f = -1, g = []; ++f < c; ) {
                var h = b[f];
                (e && Vd(h, d) || Wg.call(a, h)) && g.push(h);
            }
            return g;
        }
        function fe(a) {
            return null == a ? [] : Ud(a) ? Cf(a) ? a : Ng(a) : $f(a);
        }
        function ge(a) {
            return Cf(a) ? a : Ng(a);
        }
        function he(a) {
            if (Ai(a)) return a;
            var b = [];
            return e(a).replace(wb, function(a, c, d, e) {
                b.push(d ? e.replace(Ab, "$1") : c || a);
            }), b;
        }
        function ie(a) {
            return a instanceof Qb ? a.clone() : new _(a.__wrapped__, a.__chain__, cc(a.__actions__));
        }
        function je(a, b, c) {
            b = (c ? Wd(a, b, c) : null == b) ? 1 : rh(+b || 1, 1);
            for (var d = 0, e = a ? a.length : 0, f = -1, g = Hg(bh(e / b)); e > d; ) g[++f] = Vc(a, d, d += b);
            return g;
        }
        function ke(a) {
        ...
        function le(a, b, c) {
            var d = a ? a.length : 0;
            return d ? ((c ? Wd(a, b, c) : null == b) && (b = 1), Vc(a, 0 > b ? 0 : b)) : [];
        }
        function me(a, b, c) {
            var d = a ? a.length : 0;
            return d ? ((c ? Wd(a, b, c) : null == b) && (b = 1), b = d - (+b || 0), Vc(a, 0, 0 > b ? 0 : b)) : [];
        }
        function ne(a, b, c) {
            return a && a.length ? ad(a, Kd(b, c, 3), !0, !0) : [];
        }
        function oe(a, b, c) {
            return a && a.length ? ad(a, Kd(b, c, 3), !0) : [];
        }
        function pe(a, b, c, d) {
            var e = a ? a.length : 0;
            return e ? (c && "number" != typeof c && Wd(a, b, c) && (c = 0, d = e), zc(a, b, c, d)) : [];
        }
        function qe(a) {
            return a ? a[0] : v;
        }
        function re(a, b, c) {
            var d = a ? a.length : 0;
            return c && Wd(a, b, c) && (b = !1), d ? Cc(a, b) : [];
        }
        function se(a) {
            var b = a ? a.length : 0;
            return b ? Cc(a, !0) : [];
        ...
        function te(a, b, d) {
            var e = a ? a.length : 0;
            if (!e) return -1;
            if ("number" == typeof d) d = 0 > d ? rh(e + d, 0) : d; else if (d) {
                var f = cd(a, b), g = a[f];
        ...
        function we(a, b, c) {
            ...
            if (!d) return -1;
            var e = d;
            if ("number" == typeof c) e = (0 > c ? rh(d + c, 0) : sh(c || 0, d - 1)) + 1; else if (c) {
                e = cd(a, b, !0) - 1;
                var f = a[e];
        ...
        function xe() {
            ...
            for (var c = 0, d = Md(), e = a.length; ++c < e; ) for (var f = 0, g = a[c]; (f = d(b, g, f)) > -1; ) jh.call(b, f, 1);
            return b;
        }
        function ye(a, b, c) {
            var d = [];
        ...
        function Ae(a, b, c) {
            var d = a ? a.length : 0;
            return d ? (c && "number" != typeof c && Wd(a, b, c) && (b = 0, c = d), Vc(a, b, c)) : [];
        }
        function Be(a, b, c) {
            var d = a ? a.length : 0;
            return d ? ((c ? Wd(a, b, c) : null == b) && (b = 1), Vc(a, 0, 0 > b ? 0 : b)) : [];
        }
        function Ce(a, b, c) {
            var d = a ? a.length : 0;
            return d ? ((c ? Wd(a, b, c) : null == b) && (b = 1), b = d - (+b || 0), Vc(a, 0 > b ? 0 : b)) : [];
        }
        function De(a, b, c) {
            return a && a.length ? ad(a, Kd(b, c, 3), !1, !0) : [];
        }
        function Ee(a, b, c) {
            return a && a.length ? ad(a, Kd(b, c, 3)) : [];
        }
        function Fe(a, b, d, e) {
            var f = a ? a.length : 0;
            if (!f) return [];
            null != b && "boolean" != typeof b && (e = d, d = Wd(a, b, e) ? null : b, b = !1);
            var g = Kd();
            return (null != d || g !== tc) && (d = g(d, e, 3)), b && Md() == c ? q(a, d) : $c(a, d);
        }
        function Ge(a) {
            if (!a || !a.length) return [];
            var b = -1, c = 0;
            a = hc(a, function(a) {
                return Ud(a) ? (c = rh(a.length, c), !0) : void 0;
            });
            for (var d = Hg(c); ++b < c; ) d[b] = ic(a, Qc(b));
            return d;
        }
        function He(a, b, c) {
            var d = a ? a.length : 0;
            if (!d) return [];
            var e = Ge(a);
            return null == b ? e : (b = ed(b, c, 4), ic(e, function(a) {
                return jc(a, b, v, !0);
            }));
        }
        function Ie() {
            for (var a = -1, b = arguments.length; ++a < b; ) {
                var c = arguments[a];
                if (Ud(c)) var d = d ? wc(d, c).concat(wc(c, d)) : c;
            }
            return d ? $c(d) : [];
        }
        function Je(a, b) {
            var c = -1, d = a ? a.length : 0, e = {};
            for (!d || b || Ai(a[0]) || (b = []); ++c < d; ) {
                var f = a[c];
        ...
        function Qe() {
            ...
            return a instanceof Qb ? (this.__actions__.length && (a = new Qb(this)), new _(a.reverse(), this.__chain__)) : this.thru(function(a) {
                return a.reverse();
            });
        }
        function Re() {
        ...
        function Te(a, b, c) {
            var d = Ai(a) ? fc : xc;
            return c && Wd(a, b, c) && (b = null), ("function" != typeof b || c !== v) && (b = Kd(b, c, 3)), 
            d(a, b);
        }
        function Ue(a, b, c) {
            var d = Ai(a) ? hc : Ac;
        ...
        function We(a, b, c, d) {
            var e = a ? Ph(a) : 0;
            return Zd(e) || (a = $f(a), e = a.length), e ? (c = "number" != typeof c || d && Wd(b, c, d) ? 0 : 0 > c ? rh(e + c, 0) : c || 0, 
            "string" == typeof a || !Ai(a) && Jf(a) ? e > c && a.indexOf(b, c) > -1 : Md(a, b, c) > -1) : !1;
        }
        function Xe(a, b, c) {
            var d = Ai(a) ? ic : Lc;
            return b = Kd(b, c, 3), d(a, b);
        ...
        function $e(a, b, c) {
            if (c ? Wd(a, b, c) : null == b) {
                a = fe(a);
                var d = a.length;
                return d > 0 ? a[Tc(0, d - 1)] : v;
            }
            var e = -1, f = Of(a), d = f.length, g = d - 1;
            for (b = sh(0 > b ? 0 : +b || 0, d); ++e < b; ) {
                var h = Tc(e, g), i = f[h];
                f[h] = f[e], f[e] = i;
            }
            return f.length = b, f;
        ...
        function df(a, b, c, d) {
            return null == a ? [] : (d && Wd(b, c, d) && (c = null), Ai(b) || (b = null == b ? [] : [ b ]), 
            Ai(c) || (c = null == c ? [] : [ c ]), Yc(a, b, c));
        }
        function ef(a, b) {
            return Ue(a, Mc(b));
        }
        function ff(a, b) {
            ...
            return a = ph(a = +a) ? a : 0, function() {
                return --a < 1 ? b.apply(this, arguments) : void 0;
            };
        }
        function gf(a, b, c) {
            return c && Wd(a, b, c) && (b = null), b = a && null == b ? a.length : rh(+b || 0, 0), 
            Gd(a, E, null, null, null, null, b);
        }
        function hf(a, b) {
            var c;
            if ("function" != typeof b) {
        ...
        function jf(a, b, c) {
            ...
            function e() {
                ...
                if (0 >= c || c > b) {
                    i && ch(i);
                    var d = n;
                    i = m = n = v, d && (o = ni(), j = a.apply(l, h), m || i || (h = l = null));
                } else m = ih(e, c);
            }
            function f() {
                m && ch(m), i = m = n = v, (q || p !== b) && (o = ni(), j = a.apply(l, h), m || i || (h = l = null));
            }
            function g() {
                if (h = arguments, k = ni(), l = this, n = q && (m || !r), p === !1) var c = r && !m; else {
                    i || r || (o = k);
                    var d = p - (k - o), g = 0 >= d || d > p;
                    g ? (i && (i = ch(i)), o = k, j = a.apply(l, h)) : i || (i = ih(f, d));
                }
                return g && m ? m = ch(m) : m || b === p || (m = ih(e, b)), c && (g = !0, j = a.apply(l, h)), 
                !g || m || i || (h = l = null), j;
            }
            ...
            if (b = 0 > b ? 0 : +b || 0, c === !0) {
                var r = !0;
                q = !1;
            } else Cf(c) && (r = c.leading, p = "maxWait" in c && rh(+c.maxWait || 0, b), q = "trailing" in c ? c.trailing : q);
            return g.cancel = d, g;
        }
        function kf(a, b) {
            if ("function" != typeof a || b && "function" != typeof b) throw new Qg(N);
            var c = function() {
        ...
        function nf(a, b) {
            if ("function" != typeof a) throw new Qg(N);
            return b = rh(b === v ? a.length - 1 : +b || 0, 0), function() {
                for (var c = arguments, d = -1, e = rh(c.length - b, 0), f = Hg(e); ++d < e; ) f[d] = c[b + d];
                switch (b) {
                  case 0:
        ...
        function pf(a, b, c) {
            var d = !0, e = !0;
            if ("function" != typeof a) throw new Qg(N);
            return c === !1 ? d = !1 : Cf(c) && (d = "leading" in c ? !!c.leading : d, e = "trailing" in c ? !!c.trailing : e), 
            Pb.leading = d, Pb.maxWait = +b, Pb.trailing = e, jf(a, b, Pb);
        }
        function qf(a, b) {
            return b = null == b ? ug : b, Gd(b, C, null, [ a ], []);
        }
        function rf(a, b, c, d) {
            return b && "boolean" != typeof b && Wd(a, b, c) ? b = !1 : "function" == typeof b && (d = c, 
            c = b, b = !1), "function" == typeof c ? uc(a, b, ed(c, d, 1)) : uc(a, b);
        }
        function sf(a, b, c) {
            return "function" == typeof b ? uc(a, !0, ed(b, c, 1)) : uc(a, !0);
        }
        function tf(a, b) {
            return a > b;
        }
        ...
        function vf(a) {
            return n(a) && Ud(a) && Yg.call(a) == P;
        }
        function wf(a) {
            return a === !0 || a === !1 || n(a) && Yg.call(a) == R;
        }
        function xf(a) {
            return n(a) && Yg.call(a) == S;
        }
        function yf(a) {
            return !!a && 1 === a.nodeType && n(a) && Yg.call(a).indexOf("Element") > -1;
        }
        function zf(a) {
            return null == a ? !0 : Ud(a) && (Ai(a) || Jf(a) || vf(a) || n(a) && Ci(a.splice)) ? !a.length : !Mi(a).length;
        }
        function Af(a, b, c, d) {
            c = "function" == typeof c ? ed(c, d, 3) : v;
            var e = c ? c(a, b) : v;
            return e === v ? Ic(a, b, c) : !!e;
        }
        function Bf(a) {
            return n(a) && "string" == typeof a.message && Yg.call(a) == T;
        }
        function Cf(a) {
            var b = typeof a;
        ...
        function Df(a, b, c, d) {
            return c = "function" == typeof c ? ed(c, d, 3) : v, Kc(a, Nd(b), c);
        }
        function Ef(a) {
            return Hf(a) && a != +a;
        }
        function Ff(a) {
            return null == a ? !1 : Yg.call(a) == U ? $g.test(Vg.call(a)) : n(a) && Eb.test(a);
        }
        function Gf(a) {
            return null === a;
        }
        function Hf(a) {
            return "number" == typeof a || n(a) && Yg.call(a) == W;
        }
        function If(a) {
            return n(a) && Yg.call(a) == Y;
        }
        function Jf(a) {
            return "string" == typeof a || n(a) && Yg.call(a) == $;
        }
        function Kf(a) {
            return n(a) && Zd(a.length) && !!Nb[Yg.call(a)];
        }
        function Lf(a) {
            return a === v;
        }
        ...
        function Qf(a, b, c) {
            var d = Hh(a);
            return c && Wd(a, b, c) && (b = null), b ? qc(d, b) : d;
        }
        function Rf(a) {
            return Gc(a, Vf(a));
        }
        function Sf(a, b, c) {
            var d = null == a ? v : Hc(a, he(b), b + "");
            return d === v ? c : d;
        }
        function Tf(a, b) {
            if (null == a) return !1;
            var c = Wg.call(a, b);
            if (!c && !Xd(b)) {
                if (b = he(b), a = 1 == b.length ? a : Hc(a, Vc(b, 0, -1)), null == a) return !1;
                b = ve(b), c = Wg.call(a, b);
            }
            return c || Zd(a.length) && Vd(b, a.length) && (Ai(a) || vf(a));
        }
        function Uf(a, b, c) {
            c && Wd(a, b, c) && (b = null);
            for (var d = -1, e = Mi(a), f = e.length, g = {}; ++d < f; ) {
                var h = e[d], i = a[h];
                b ? Wg.call(g, i) ? g[i].push(h) : g[i] = [ h ] : g[i] = h;
            }
            return g;
        }
        function Vf(a) {
            ...
            Cf(a) || (a = Ng(a));
            var b = a.length;
            b = b && Zd(b) && (Ai(a) || vf(a)) && b || 0;
            for (var c = a.constructor, d = -1, e = "function" == typeof c && c.prototype === a, f = Hg(b), g = b > 0; ++d < b; ) f[d] = d + "";
            for (var h in a) g && Vd(h, b) || "constructor" == h && (e || !Wg.call(a, h)) || f.push(h);
            return f;
        }
        function Wf(a) {
            a = ge(a);
            for (var b = -1, c = Mi(a), d = c.length, e = Hg(d); ++b < d; ) {
                var f = c[b];
                e[b] = [ f, a[f] ];
            }
            return e;
        ...
        function Xf(a, b, c) {
            var d = null == a ? v : a[b];
            return d === v && (null == a || Xd(b, a) || (b = he(b), a = 1 == b.length ? a : Hc(a, Vc(b, 0, -1)), 
            d = null == a ? v : a[ve(b)]), d = d === v ? c : d), Ci(d) ? d.call(a) : d;
        }
        function Yf(a, b, c) {
            if (null == a) return a;
            var d = b + "";
            b = null != a[d] || Xd(b, a) ? [ d ] : he(b);
            for (var e = -1, f = b.length, g = f - 1, h = a; null != h && ++e < f; ) {
                var i = b[e];
                Cf(h) && (e == g ? h[i] = c : null == h[i] && (h[i] = Vd(b[e + 1]) ? [] : {})), 
                h = h[i];
            }
            return a;
        }
        function Zf(a, b, c, d) {
            var e = Ai(a) || Kf(a);
            if (b = Kd(b, d, 4), null == c) if (e || Cf(a)) {
                var f = a.constructor;
                c = e ? Ai(a) ? new f() : [] : Hh(Ci(f) ? f.prototype : null);
            } else c = {};
            return (e ? dc : Ec)(a, function(a, d, e) {
                return b(c, a, d, e);
            }), c;
        }
        function $f(a) {
        ...
        function ag(a, b, c) {
            return b = +b || 0, "undefined" == typeof c ? (c = b, b = 0) : c = +c || 0, a >= sh(b, c) && a < rh(b, c);
        }
        function bg(a, b, c) {
            c && Wd(a, b, c) && (b = c = null);
            ...
            c || a % 1 || b % 1) {
                var f = wh();
                return sh(a + f * (b - a + fh("1e-" + ((f + "").length - 1))), b);
            }
            return Tc(a, b);
        }
        function cg(a) {
        ...
        function dg(a) {
            return a = e(a), a && a.replace(Gb, j).replace(zb, "");
        }
        function eg(a, b, c) {
            a = e(a), b += "";
            var d = a.length;
            return c = c === v ? d : sh(0 > c ? 0 : +c || 0, d), c -= b.length, c >= 0 && a.indexOf(b, c) == c;
        }
        function fg(a) {
            return a = e(a), a && qb.test(a) ? a.replace(ob, k) : a;
        }
        function gg(a) {
            return a = e(a), a && yb.test(a) ? a.replace(xb, "\\$&") : a;
        }
        function hg(a, b, c) {
            a = e(a), b = +b;
            var d = a.length;
            if (d >= b || !ph(b)) return a;
            var f = (b - d) / 2, g = dh(f), h = bh(f);
            return c = Dd("", h, c), c.slice(0, g) + a + c;
        }
        function ig(a, b, c) {
            return c && Wd(a, b, c) && (b = 0), vh(a, b);
        }
        function jg(a, b) {
            var c = "";
            if (a = e(a), b = +b, 1 > b || !a || !ph(b)) return c;
            do b % 2 && (c += a), b = dh(b / 2), a += a; while (b);
            return c;
        }
        function kg(a, b, c) {
            return a = e(a), c = null == c ? 0 : sh(0 > c ? 0 : +c || 0, a.length), a.lastIndexOf(b, c) == c;
        }
        function lg(a, b, c) {
            var d = V.templateSettings;
            c && Wd(a, b, c) && (b = c = null), a = e(a), b = pc(qc({}, c || b), d, oc);
            var f, g, h = pc(qc({}, b.imports), d.imports, oc), i = Mi(h), j = _c(h, i), k = 0, m = b.interpolate || Hb, n = "__p += '", o = Og((b.escape || Hb).source + "|" + m.source + "|" + (m === tb ? Bb : Hb).source + "|" + (b.evaluate || Hb).source + "|$", "g"), p = "//# sourceURL=" + ("sourceURL" in b ? b.sourceURL : "lodash.templateSources[" + ++Mb + "]") + "\n";
            a.replace(o, function(b, c, d, e, h, i) {
                return d || (d = e), n += a.slice(k, i).replace(Ib, l), c && (f = !0, n += "' +\n__e(" + c + ") +\n'"), 
                h && (g = !0, n += "';\n" + h + ";\n__p += '"), d && (n += "' +\n((__t = (" + d + ")) == null ? '' : __t) +\n'"), 
                k = i + b.length, b;
            }), n += "';\n";
            var q = b.variable;
            q || (n = "with (obj) {\n" + n + "\n}\n"), n = (g ? n.replace(kb, "") : n).replace(lb, "$1").replace(mb, "$1;"), 
            n = "function(" + (q || "obj") + ") {\n" + (q ? "" : "obj || (obj = {});\n") + "var __t, __p = ''" + (f ? ", __e = _.escape" : "") + (g ? ", __j = Array.prototype.join;\nfunction print() { __p += __j.call(arguments, '') }\n" : ";\n") + n + "return __p\n}";
            var r = Yi(function() {
                return Kg(i, p + "return " + n).apply(v, j);
            });
        ...
        function mg(a, b, c) {
            var d = a;
            return (a = e(a)) ? (c ? Wd(d, b, c) : null == b) ? a.slice(r(a), s(a) + 1) : (b += "", 
            a.slice(f(a, b), g(a, b) + 1)) : a;
        }
        function ng(a, b, c) {
            var d = a;
            return a = e(a), a ? a.slice((c ? Wd(d, b, c) : null == b) ? r(a) : f(a, b + "")) : a;
        }
        function og(a, b, c) {
            var d = a;
            return a = e(a), a ? (c ? Wd(d, b, c) : null == b) ? a.slice(0, s(a) + 1) : a.slice(0, g(a, b + "") + 1) : a;
        }
        function pg(a, b, c) {
            c && Wd(a, b, c) && (b = null);
            var d = G, f = H;
            ...
            if (If(g)) {
                if (a.slice(h).search(g)) {
                    ...
                    for (g.global || (g = Og(g.source, (Cb.exec(g) || "") + "g")), g.lastIndex = 0; j = g.exec(l); ) k = j.index;
        ...
        function qg(a) {
            return a = e(a), a && pb.test(a) ? a.replace(nb, t) : a;
        }
        function rg(a, b, c) {
            return c && Wd(a, b, c) && (b = null), a = e(a), a.match(b || Jb) || [];
        }
        function sg(a, b, c) {
            return c && Wd(a, b, c) && (b = null), n(a) ? vg(a) : tc(a, b);
        }
        function tg(a) {
            return function() {
                return a;
        ...
        function xg(a, b, c) {
            if (null == c) {
                var d = Cf(b), e = d ? Mi(b) : null, f = e && e.length ? Gc(b, e) : null;
                (f ? f.length : d) || (f = !1, c = b, b = a, a = this);
            }
            f || (f = Gc(b, Mi(b)));
            var g = !0, h = -1, i = Ci(a), j = f.length;
            ...
            for (;++h < j; ) {
                ...
                a[k] = l, i && (a.prototype[k] = function(b) {
                    return function() {
                        ...
                        var f = [ this.value() ];
                        return gh.apply(f, arguments), b.apply(a, f);
                    };
                }(l));
            }
            return a;
        ...
        function Cg(a, b, c) {
            c && Wd(a, b, c) && (b = c = null), a = +a || 0, c = null == c ? 1 : +c || 0, null == b ? (b = a, 
            a = 0) : b = +b || 0;
            for (var d = -1, e = rh(bh((b - a) / (c || 1)), 0), f = Hg(e); ++d < e; ) f[d] = a, 
            a += c;
            return f;
        }
        function Dg(a, b, c) {
            if (a = dh(a), 1 > a || !ph(a)) return [];
            var d = -1, e = Hg(sh(a, zh));
            for (b = ed(b, c, 1); ++d < a; ) zh > d ? e[d] = b(d) : b(d);
            return e;
        }
        function Eg(a) {
            var b = ++Xg;
        ...
        function Gg(a, b, c) {
            c && Wd(a, b, c) && (b = null);
            var d = Kd(), e = null == b;
            return e && d === tc || (e = !1, b = d(b, c, 3)), e ? mc(Ai(a) ? a : fe(a)) : Zc(a, b);
        }
        o = o ? ac.defaults(_b.Object(), o, ac.pick(_b, Lb)) : _b;
        var Hg = o.Array, Ig = o.Date, Jg = o.Error, Kg = o.Function, Lg = o.Math, Mg = o.Number, Ng = o.Object, Og = o.RegExp, Pg = o.String, Qg = o.TypeError, Rg = Hg.prototype, Sg = Ng.prototype, Tg = Pg.prototype, Ug = (Ug = o.window) ? Ug.document : null, Vg = Kg.prototype.toString, Wg = Sg.hasOwnProperty, Xg = 0, Yg = Sg.toString, Zg = o._, $g = Og("^" + gg(Vg.call(Wg)).replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"), _g = Od(o, "ArrayBuffer"), ah = Od(_g && new _g(0), "slice"), bh = Lg.ceil, ch = o.clearTimeout, dh = Lg.floor, eh = Od(Ng, "getPrototypeOf"), fh = o.parseFloat, gh = Rg.push, hh = Od(o, "Set"), ih = o.setTimeout, jh = Rg.splice, kh = Od(o, "Uint8Array"), lh = Od(o, "WeakMap"), mh = function() {
            try {
                var a = Od(o, "Float64Array"), b = new a(new _g(10), 0, 1) && a;
            } catch (c) {}
            return b || null;
        }(), nh = Od(Ng, "create"), oh = Od(Hg, "isArray"), ph = o.isFinite, qh = Od(Ng, "keys"), rh = Lg.max, sh = Lg.min, th = Od(Ig, "now"), uh = Od(Mg, "isFinite"), vh = o.parseInt, wh = Lg.random, xh = Mg.NEGATIVE_INFINITY, yh = Mg.POSITIVE_INFINITY, zh = 4294967295, Ah = zh - 1, Bh = zh >>> 1, Ch = mh ? mh.BYTES_PER_ELEMENT : 0, Dh = 9007199254740991, Eh = lh && new lh(), Fh = {}, Gh = V.support = {};
        !function(a) {
            var b = function() {
                this.x = a;
            }, c = [];
            ...
            try {
                Gh.dom = 11 === Ug.createDocumentFragment().nodeType;
            } catch (e) {
                Gh.dom = !1;
            }
        ...
        }(), Ih = kd(Ec), Jh = kd(Fc, !0), Kh = ld(), Lh = ld(!0), Mh = Eh ? function(a, b) {
            return Eh.set(a, b), a;
        } : ug;
        ah || (fd = _g && kh ? function(a) {
            var b = a.byteLength, c = mh ? dh(b / Ch) : 0, d = c * Ch, e = new _g(b);
            if (c) {
                var f = new mh(e, 0, c);
                f.set(new mh(a, 0, c));
            }
            return b != d && (f = new kh(e, d), f.set(new kh(a, d))), e;
        } : tg(null));
        var Nh = nh && hh ? function(a) {
            return new Zb(a);
        } : tg(null), Oh = Eh ? function(a) {
            return Eh.get(a);
        } : zg, Ph = Qc("length"), Qh = function() {
            var a = 0, b = 0;
            return function(c, d) {
                var e = ni(), f = J - (e - b);
                if (b = e, f > 0) {
            ...
            return Ud(a) ? wc(a, Cc(b, !1, !0)) : [];
        }), Sh = sd(), Th = sd(!0), Uh = nf(function(a) {
            for (var b = a.length, d = b, e = Hg(l), f = Md(), g = f == c, h = []; d--; ) {
                var i = a[d] = Ud(i = a[d]) ? i : [];
                e[d] = g && i.length >= 120 ? Nh(d && i) : null;
            }
            var j = a[0], k = -1, l = j ? j.length : 0, m = e[0];
            a: for (;++k < l; ) if (i = j[k], (m ? $b(m, i) : f(h, i, 0)) < 0) {
                for (var d = b; --d; ) {
                    var n = e[d];
                    if ((n ? $b(n, i) : f(a[d], i, 0)) < 0) continue a;
                }
                m && m.push(i), h.push(i);
            }
            return h;
            ...
            c = Cc(c);
            var d = rc(b, c);
            return Sc(b, c.sort(a)), d;
        }), Wh = Fd(), Xh = Fd(!0), Yh = nf(function(a) {
            return $c(Cc(a, !1, !0));
        }), Zh = nf(function(a, b) {
            return Ud(a) ? wc(a, b) : [];
        }), $h = nf(Ge), _h = nf(function(a) {
            var b = a.length, c = b > 2 ? a[b - 2] : v, d = b > 1 ? a[b - 1] : v;
            return b > 2 && "function" == typeof c ? b -= 2 : (c = b > 1 && "function" == typeof d ? (--b, 
            d) : v, d = v), a.length = b, He(a, c, d);
        }), ai = nf(function(a, b) {
            return rc(a, Cc(b));
        }), bi = id(function(a, b, c) {
            Wg.call(a, c) ? ++a[c] : a[c] = 1;
        }), ci = rd(Ih), di = rd(Jh, !0), ei = vd(dc, Ih), fi = vd(ec, Jh), gi = id(function(a, b, c) {
            Wg.call(a, c) ? a[c].push(b) : a[c] = [ b ];
        }), hi = id(function(a, b, c) {
            a[c] = b;
        }), ii = nf(function(a, b, c) {
            var d = -1, e = "function" == typeof b, f = Xd(b), g = Ud(a) ? Hg(a.length) : [];
            return Ih(a, function(a) {
                var h = e ? b : f && null != a ? a[b] : null;
                g[++d] = h ? h.apply(a, c) : Td(a, b, c);
            }), g;
        }), ji = id(function(a, b, c) {
            a[c ? 0 : 1].push(b);
        }, function() {
            return [ [], [] ];
        }), ki = Bd(jc, Ih), li = Bd(kc, Jh), mi = nf(function(a, b) {
            if (null == a) return [];
            var c = b[2];
            return c && Wd(b[0], b[1], c) && (b.length = 1), Yc(a, Cc(b), []);
        }), ni = th || function() {
            return new Ig().getTime();
        }, oi = nf(function(a, b, c) {
            var d = x;
            if (c.length) {
                var e = p(c, oi.placeholder);
                d |= C;
            }
            return Gd(a, d, b, c, e);
        }), pi = nf(function(a, b) {
            b = b.length ? Cc(b) : Rf(a);
            for (var c = -1, d = b.length; ++c < d; ) {
                var e = b[c];
                a[e] = Gd(a[e], x, a);
            }
            return a;
        }), qi = nf(function(a, b, c) {
            var d = x | y;
            if (c.length) {
                var e = p(c, qi.placeholder);
                d |= C;
            }
            return Gd(b, d, a, c, e);
        }), ri = pd(A), si = pd(B), ti = nf(function(a, b) {
            return vc(a, 1, b);
        }), ui = nf(function(a, b, c) {
            return vc(a, b, c);
        }), vi = ud(), wi = ud(!0), xi = Ad(C), yi = Ad(D), zi = nf(function(a, b) {
            return Gd(a, F, null, null, null, Cc(b));
        }), Ai = oh || function(a) {
            return n(a) && Zd(a.length) && Yg.call(a) == Q;
        };
        Gh.dom || (yf = function(a) {
            return !!a && 1 === a.nodeType && n(a) && !Di(a);
        });
        var Bi = uh || function(a) {
            return "number" == typeof a && ph(a);
        }, Ci = d(/x/) || kh && !d(kh) ? function(a) {
            return Yg.call(a) == U;
        } : d, Di = eh ? function(a) {
            if (!a || Yg.call(a) != X) return !1;
            var b = Od(a, "valueOf"), c = b && (c = eh(b)) && eh(c);
            return c ? a == c || eh(a) == c : de(a);
        } : de, Ei = jd(function(a, b, c) {
            return c ? pc(a, b, c) : qc(a, b);
        }), Fi = nf(function(a) {
            var b = a[0];
            return null == b ? b : (a.push(nc), Ei.apply(v, a));
        }), Gi = td(Ec), Hi = td(Fc), Ii = wd(Kh), Ji = wd(Lh), Ki = xd(Ec), Li = xd(Fc), Mi = qh ? function(a) {
            var b = null == a ? null : a.constructor;
            return "function" == typeof b && b.prototype === a || "function" != typeof a && Ud(a) ? ee(a) : Cf(a) ? qh(a) : [];
        } : ee, Ni = yd(!0), Oi = yd(), Pi = jd(Oc), Qi = nf(function(a, b) {
            if (null == a) return {};
            if ("function" != typeof b[0]) {
                var b = ic(Cc(b), Pg);
                return ae(a, wc(Vf(a), b));
            }
            var c = ed(b[0], b[1], 3);
            return be(a, function(a, b, d) {
                return !c(a, b, d);
            });
        }), Ri = nf(function(a, b) {
            return null == a ? {} : "function" == typeof b[0] ? be(a, ed(b[0], b[1], 3)) : ae(a, Cc(b));
        }), Si = nd(function(a, b, c) {
            return b = b.toLowerCase(), a + (c ? b.charAt(0).toUpperCase() + b.slice(1) : b);
        }), Ti = nd(function(a, b, c) {
            return a + (c ? "-" : "") + b.toLowerCase();
        }), Ui = zd(), Vi = zd(!0);
        8 != vh(Kb + "08") && (ig = function(a, b, c) {
            return (c ? Wd(a, b, c) : null == b) ? b = 0 : b && (b = +b), a = mg(a), vh(a, b || (Db.test(a) ? 16 : 10));
        });
        var Wi = nd(function(a, b, c) {
            return a + (c ? "_" : "") + b.toLowerCase();
        }), Xi = nd(function(a, b, c) {
            return a + (c ? " " : "") + (b.charAt(0).toUpperCase() + b.slice(1));
        }), Yi = nf(function(a, b) {
            try {
                return a.apply(v, b);
            } catch (c) {
                return Bf(c) ? c : new Jg(c);
            }
        }), Zi = nf(function(a, b) {
            return function(c) {
                return Td(c, a, b);
        ...
        }), _i = qd(tf, xh), aj = qd(Mf, yh);
        return V.prototype = Z.prototype, _.prototype = Hh(Z.prototype), _.prototype.constructor = _, 
        Qb.prototype = Hh(Z.prototype), Qb.prototype.constructor = Qb, Ub.prototype["delete"] = Vb, 
        Ub.prototype.get = Wb, Ub.prototype.has = Xb, Ub.prototype.set = Yb, Zb.prototype.push = bc, 
        kf.Cache = Ub, V.after = ff, V.ary = gf, V.assign = Ei, V.at = ai, V.before = hf, 
        V.bind = oi, V.bindAll = pi, V.bindKey = qi, V.callback = sg, V.chain = Ke, V.chunk = je, 
        V.compact = ke, V.constant = tg, V.countBy = bi, V.create = Qf, V.curry = ri, V.curryRight = si, 
        V.debounce = jf, V.defaults = Fi, V.defer = ti, V.delay = ui, V.difference = Rh, 
        V.drop = le, V.dropRight = me, V.dropRightWhile = ne, V.dropWhile = oe, V.fill = pe, 
        V.filter = Ue, V.flatten = re, V.flattenDeep = se, V.flow = vi, V.flowRight = wi, 
        V.forEach = ei, V.forEachRight = fi, V.forIn = Ii, V.forInRight = Ji, V.forOwn = Ki, 
        V.forOwnRight = Li, V.functions = Rf, V.groupBy = gi, V.indexBy = hi, V.initial = ue, 
        V.intersection = Uh, V.invert = Uf, V.invoke = ii, V.keys = Mi, V.keysIn = Vf, V.map = Xe, 
        V.mapKeys = Ni, V.mapValues = Oi, V.matches = vg, V.matchesProperty = wg, V.memoize = kf, 
        V.merge = Pi, V.method = Zi, V.methodOf = $i, V.mixin = xg, V.negate = lf, V.omit = Qi, 
        V.once = mf, V.pairs = Wf, V.partial = xi, V.partialRight = yi, V.partition = ji, 
        V.pick = Ri, V.pluck = Ye, V.property = Ag, V.propertyOf = Bg, V.pull = xe, V.pullAt = Vh, 
        V.range = Cg, V.rearg = zi, V.reject = Ze, V.remove = ye, V.rest = ze, V.restParam = nf, 
        V.set = Yf, V.shuffle = _e, V.slice = Ae, V.sortBy = cf, V.sortByAll = mi, V.sortByOrder = df, 
        V.spread = of, V.take = Be, V.takeRight = Ce, V.takeRightWhile = De, V.takeWhile = Ee, 
        V.tap = Le, V.throttle = pf, V.thru = Me, V.times = Dg, V.toArray = Of, V.toPlainObject = Pf, 
        V.transform = Zf, V.union = Yh, V.uniq = Fe, V.unzip = Ge, V.unzipWith = He, V.values = $f, 
        V.valuesIn = _f, V.where = ef, V.without = Zh, V.wrap = qf, V.xor = Ie, V.zip = $h, 
        V.zipObject = Je, V.zipWith = _h, V.backflow = wi, V.collect = Xe, V.compose = wi, 
        V.each = ei, V.eachRight = fi, V.extend = Ei, V.iteratee = sg, V.methods = Rf, V.object = Je, 
        V.select = Ue, V.tail = ze, V.unique = Fe, xg(V, V), V.add = Fg, V.attempt = Yi, 
        V.camelCase = Si, V.capitalize = cg, V.clone = rf, V.cloneDeep = sf, V.deburr = dg, 
        V.endsWith = eg, V.escape = fg, V.escapeRegExp = gg, V.every = Te, V.find = ci, 
        V.findIndex = Sh, V.findKey = Gi, V.findLast = di, V.findLastIndex = Th, V.findLastKey = Hi, 
        V.findWhere = Ve, V.first = qe, V.get = Sf, V.gt = tf, V.gte = uf, V.has = Tf, V.identity = ug, 
        V.includes = We, V.indexOf = te, V.inRange = ag, V.isArguments = vf, V.isArray = Ai, 
        V.isBoolean = wf, V.isDate = xf, V.isElement = yf, V.isEmpty = zf, V.isEqual = Af, 
        V.isError = Bf, V.isFinite = Bi, V.isFunction = Ci, V.isMatch = Df, V.isNaN = Ef, 
        V.isNative = Ff, V.isNull = Gf, V.isNumber = Hf, V.isObject = Cf, V.isPlainObject = Di, 
        V.isRegExp = If, V.isString = Jf, V.isTypedArray = Kf, V.isUndefined = Lf, V.kebabCase = Ti, 
        V.last = ve, V.lastIndexOf = we, V.lt = Mf, V.lte = Nf, V.max = _i, V.min = aj, 
        V.noConflict = yg, V.noop = zg, V.now = ni, V.pad = hg, V.padLeft = Ui, V.padRight = Vi, 
        V.parseInt = ig, V.random = bg, V.reduce = ki, V.reduceRight = li, V.repeat = jg, 
        V.result = Xf, V.runInContext = u, V.size = af, V.snakeCase = Wi, V.some = bf, V.sortedIndex = Wh, 
        V.sortedLastIndex = Xh, V.startCase = Xi, V.startsWith = kg, V.sum = Gg, V.template = lg, 
        V.trim = mg, V.trimLeft = ng, V.trimRight = og, V.trunc = pg, V.unescape = qg, V.uniqueId = Eg, 
        V.words = rg, V.all = Te, V.any = bf, V.contains = We, V.eq = Af, V.detect = ci, 
        V.foldl = ki, V.foldr = li, V.head = qe, V.include = We, V.inject = ki, xg(V, function() {
            var a = {};
            return Ec(V, function(b, c) {
                V.prototype[c] || (a[c] = b);
            }), a;
        }(), !1), V.sample = $e, V.prototype.sample = function(a) {
            return this.__chain__ || null != a ? this.thru(function(b) {
                return $e(b, a);
            }) : $e(this.value());
        }, V.VERSION = w, dc([ "bind", "bindKey", "curry", "curryRight", "partial", "partialRight" ], function(a) {
            V[a].placeholder = V;
        }), dc([ "dropWhile", "filter", "map", "takeWhile" ], function(a, b) {
            var c = b != M, d = b == K;
            Qb.prototype[a] = function(a, e) {
                var f = this.__filtered__, g = f && d ? new Qb(this) : this.clone(), h = g.__iteratees__ || (g.__iteratees__ = []);
                return h.push({
                    done: !1,
                    count: 0,
                    index: 0,
            ...
            var c = a + "While";
            Qb.prototype[a] = function(c) {
                var d = this.__filtered__, e = d && !b ? this.dropWhile() : this.clone();
                if (c = null == c ? 1 : rh(dh(c) || 0, 0), d) b ? e.__takeCount__ = sh(e.__takeCount__, c) : ve(e.__iteratees__).limit = c; else {
                ...
                return e;
            }, Qb.prototype[a + "Right"] = function(b) {
                return this.reverse()[a](b).reverse();
            }, Qb.prototype[a + "RightWhile"] = function(a, b) {
            ...
            var c = b ? "filter" : "map", d = b ? Mc : Ag;
            Qb.prototype[a] = function(a) {
                return this[c](d(a));
            };
        }), Qb.prototype.compact = function() {
            return this.filter(ug);
        }, Qb.prototype.reject = function(a, b) {
            return a = Kd(a, b, 1), this.filter(function(b) {
                return !a(b);
            });
        }, Qb.prototype.slice = function(a, b) {
            a = null == a ? 0 : +a || 0;
            var c = this;
            return 0 > a ? c = this.takeRight(-a) : a && (c = this.drop(a)), b !== v && (b = +b || 0, 
            c = 0 > b ? c.dropRight(-b) : c.take(b - a)), c;
        }, Qb.prototype.toArray = function() {
            return this.drop(0);
        }, Ec(Qb.prototype, function(a, b) {
            var c = V[b];
            if (c) {
                var d = /^(?:filter|map|reject)|While$/.test(b), e = /^(?:first|last)$/.test(b);
                V.prototype[b] = function() {
                    var b = arguments, f = this.__chain__, g = this.__wrapped__, h = !!this.__actions__.length, i = g instanceof Qb, j = b[0], k = i || Ai(g);
                    k && d && "function" == typeof j && 1 != j.length && (i = k = !1);
                    var l = i && !h;
                    if (e && !f) return l ? a.call(g) : c.call(V, this.value());
                    var m = function(a) {
                        var d = [ a ];
                        return gh.apply(d, b), c.apply(V, d);
                    };
                    if (k) {
                        var n = l ? g : new Qb(this), o = a.apply(n, b);
            ...
            var b = (/^(?:replace|split)$/.test(a) ? Tg : Rg)[a], c = /^(?:push|sort|unshift)$/.test(a) ? "tap" : "thru", d = /^(?:join|pop|replace|shift)$/.test(a);
            ...
            name: "wrapper",
            func: null
        } ], Qb.prototype.clone = Rb, Qb.prototype.reverse = Sb, Qb.prototype.value = Tb, 
        V.prototype.chain = Ne, V.prototype.commit = Oe, V.prototype.plant = Pe, V.prototype.reverse = Qe, 
        V.prototype.toString = Re, V.prototype.run = V.prototype.toJSON = V.prototype.valueOf = V.prototype.value = Se, 
        V.prototype.collect = V.prototype.map, V.prototype.head = V.prototype.first, V.prototype.select = V.prototype.filter, 
        V.prototype.tail = V.prototype.rest, V;
    }
    var v, w = "3.9.3", x = 1, y = 2, z = 4, A = 8, B = 16, C = 32, D = 64, E = 128, F = 256, G = 30, H = "...", I = 150, J = 16, K = 0, L = 1, M = 2, N = "Expected a function", O = "__lodash_placeholder__", P = "[object Arguments]", Q = "[object Array]", R = "[object Boolean]", S = "[object Date]", T = "[object Error]", U = "[object Function]", V = "[object Map]", W = "[object Number]", X = "[object Object]", Y = "[object RegExp]", Z = "[object Set]", $ = "[object String]", _ = "[object WeakMap]", ab = "[object ArrayBuffer]", bb = "[object Float32Array]", cb = "[object Float64Array]", db = "[object Int8Array]", eb = "[object Int16Array]", fb = "[object Int32Array]", gb = "[object Uint8Array]", hb = "[object Uint8ClampedArray]", ib = "[object Uint16Array]", jb = "[object Uint32Array]", kb = /\b__p \+= '';/g, lb = /\b(__p \+=) '' \+/g, mb = /(__e\(.*?\)|\b__t\)) \+\n'';/g, nb = /&(?:amp|lt|gt|quot|#39|#96);/g, ob = /[&<>"'`]/g, pb = RegExp(nb.source), qb = RegExp(ob.source), rb = /<%-([\s\S]+?)%>/g, sb = /<%([\s\S]+?)%>/g, tb = /<%=([\s\S]+?)%>/g, ub = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\n\\]|\\.)*?\1)\]/, vb = /^\w*$/, wb = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\n\\]|\\.)*?)\2)\]/g, xb = /[.*+?^${}()|[\]\/\\]/g, yb = RegExp(xb.source), zb = /[\u0300-\u036f\ufe20-\ufe23]/g, Ab = /\\(\\)?/g, Bb = /\$\{([^\\}]*(?:\\.[^\\}]*)*)\}/g, Cb = /\w*$/, Db = /^0[xX]/, Eb = /^\[object .+?Constructor\]$/, Fb = /^\d+$/, Gb = /[\xc0-\xd6\xd8-\xde\xdf-\xf6\xf8-\xff]/g, Hb = /($^)/, Ib = /['\n\r\u2028\u2029\\]/g, Jb = function() {
        var a = "[A-Z\\xc0-\\xd6\\xd8-\\xde]", b = "[a-z\\xdf-\\xf6\\xf8-\\xff]+";
        return RegExp(a + "+(?=" + a + b + ")|" + a + "?" + b + "|" + a + "+|[0-9]+", "g");
    }(), Kb = " 	\f ﻿\n\r\u2028\u2029 ᠎             　", Lb = [ "Array", "ArrayBuffer", "Date", "Error", "Float32Array", "Float64Array", "Function", "Int8Array", "Int16Array", "Int32Array", "Math", "Number", "Object", "RegExp", "Set", "String", "_", "clearTimeout", "document", "isFinite", "parseFloat", "parseInt", "setTimeout", "TypeError", "Uint8Array", "Uint8ClampedArray", "Uint16Array", "Uint32Array", "WeakMap", "window" ], Mb = -1, Nb = {};
    Nb[bb] = Nb[cb] = Nb[db] = Nb[eb] = Nb[fb] = Nb[gb] = Nb[hb] = Nb[ib] = Nb[jb] = !0, 
    Nb[P] = Nb[Q] = Nb[ab] = Nb[R] = Nb[S] = Nb[T] = Nb[U] = Nb[V] = Nb[W] = Nb[X] = Nb[Y] = Nb[Z] = Nb[$] = Nb[_] = !1;
    var Ob = {};
    Ob[P] = Ob[Q] = Ob[ab] = Ob[R] = Ob[S] = Ob[bb] = Ob[cb] = Ob[db] = Ob[eb] = Ob[fb] = Ob[W] = Ob[X] = Ob[Y] = Ob[$] = Ob[gb] = Ob[hb] = Ob[ib] = Ob[jb] = !0, 
    Ob[T] = Ob[U] = Ob[V] = Ob[Z] = Ob[_] = !1;
    var Pb = {
        leading: !1,
        maxWait: 0,
        trailing: !1
        ...
        "\u2028": "u2028",
        "\u2029": "u2029"
    }, Vb = Tb[typeof exports] && exports && !exports.nodeType && exports, Wb = Tb[typeof module] && module && !module.nodeType && module, Xb = Vb && Wb && "object" == typeof global && global && global.Object && global, Yb = Tb[typeof self] && self && self.Object && self, Zb = Tb[typeof window] && window && window.Object && window, $b = Wb && Wb.exports === Vb && Vb, _b = Xb || Zb !== (this && this.window) && Zb || Yb || this, ac = u();
    "function" == typeof define && "object" == typeof define.amd && define.amd ? (_b._ = ac, 
    define(function() {
        return ac;
    })) : Vb && Wb ? $b ? (Wb.exports = ac)._ = ac : Vb._ = ac : _b._ = ac;
    ...
    function nb(b) {
        ...
        ae("ng", [ "ngLocale" ], [ "$provide", function(a) {
            a.provider({
                ...
                ngInclude: hg
            }).directive(Df).directive(dg), a.provider({
                $anchorScroll: Tb,
                $animate: Te,
                $browser: Wb,
                $cacheFactory: Xb,
        ...
        this.register = function(b, c) {
            ...
            return function(d, i, j, k) {
                ...
                if (j = j === !0, k && u(k) && (p = k), u(d)) {
                    ...
                    o = n[1], p = p || n[3], d = a.hasOwnProperty(o) ? a[o] : hb(i.$scope, o, !0) || (b ? hb(g, o, !0) : c), 
                    fb(d, o, !0);
                }
                if (j) {
    ...
    function gd(a) {
        ...
        b("lowercase", Af), b("number", ld), b("orderBy", yd), b("uppercase", Bf);
    }
    function hd() {
    ...
    function vd(a) {
        ...
        return function(c, d, e) {
            var g, h, i = "", j = [];
            if (d = d || "mediumDate", d = a.DATETIME_FORMATS[d] || d, u(c) && (c = zf.test(c) ? m(c) : b(c)), 
    ...
    function Bd(a, b, d, e, g) {
        ...
        j.$addControl(h), h.$rollbackViewValue = function() {
            ...
            e.setClass(a, mg, ng + " " + Ff), h.$dirty = !1, h.$pristine = !0, h.$submitted = !1, 
            f(i, function(a) {
                a.$setPristine();
            });
    ...
    function Qd(a) {
        function b(a, b, i) {
            ...
            l(h.$$success, a, i)), h.$pending ? (f(qg, !0), h.$valid = h.$invalid = c, g("", null)) : (f(qg, !1), 
    ...
    var Ve = /^((?:x|data)[\:\-_])/i, We = d("$controller"), Xe = "application/json", Ye = {
    ...
    var fg = [ "$animate", function(a) {
        ...
        var w = e.inheritedData("$formController") || Ef, y = 0;
        Qd({
            ctrl: this,
            $element: e,
            set: function(a, b) {
            ...
            u.$dirty = !1, u.$pristine = !0, h.removeClass(e, ng), h.addClass(e, mg);
        }, this.$setDirty = function() {
            u.$dirty = !0, u.$pristine = !1, h.removeClass(e, mg), h.addClass(e, ng), w.$setDirty();
        }, this.$setUntouched = function() {
            u.$touched = !1, u.$untouched = !0, h.setClass(e, og, pg);
        }, this.$setTouched = function() {
            u.$touched = !0, u.$untouched = !1, h.setClass(e, pg, og);
        ...
        return {
            ...
            controller: [ "$scope", "$attrs", function(a, b) {
                ...
                this.$options.updateOn = ke(this.$options.updateOn.replace(ug, function() {
        ...
        terminal: !0,
        priority: 1e3
    }), xg = [ "$locale", "$interpolate", function(a, b) {
...
function(a, b, c) {
    ...
    e.factory("$swipe", [ function() {
        ...
        return {
            bind: function(b, e, f) {
                ...
                l && b.on(l, function(a) {
                    ...
                    if (k && i) {
                        var c = a(b);
                        if (g += Math.abs(c.x - j.x), h += Math.abs(c.y - j.y), j = c, !(d > g && d > h)) return h > g ? (k = !1, 
                        void (e.cancel && e.cancel(b))) : (b.preventDefault(), void (e.move && e.move(c, b)));
                    }
    ...
    } ]), e.directive("ngClick", [ "$parse", "$timeout", "$rootElement", function(a, d, e) {
        function f(a, b, c, d) {
        ...
        function h(a) {
            if (!(Date.now() - k > p)) {
                ...
                1 > d && 1 > e || m && m[0] === d && m[1] === e || (m && (m = null), "label" === c(a.target) && (m = [ d, e ]), 
                g(l, d, e) || (a.stopPropagation(), a.preventDefault(), a.target && a.target.blur && a.target.blur()));
            }
        }
        function i(a) {
        ...
        function j(a, b) {
            l || (e[0].addEventListener("click", h, !0), e[0].addEventListener("touchstart", i, !0), 
            l = []), k = Date.now(), g(l, a, b);
        }
        ...
        return function(c, d, e) {
            ...
            d.on("touchstart", function(a) {
                m = !0, g = a.target ? a.target : a.srcElement, 3 == g.nodeType && (g = g.parentNode), 
                d.addClass(r), h = Date.now();
                ...
                m && n > c && o > t && (j(r, s), g && g.blur(), b.isDefined(e.disabled) && e.disabled !== !1 || d.triggerHandler("click", [ a ])), 
                f();
...
angular.module("ui.bootstrap.transition", []).factory("$transition", [ "$q", "$timeout", "$rootScope", function(a, b, c) {
    ...
    function g() {
        var b = +a.interval;
        j && !isNaN(b) && b > 0 ? a.next() : a.pause();
    }
    function h() {
        var b = [];
        a.pause();
        for (var c = h.arguments[0].length - 1; c >= 0; c--) b[c] = new Image(), b[c].src = h.arguments[0][c];
        a.play();
    }
    var i, j, k = this, l = k.slides = a.slides = [], m = -1;
    k.currentSlide = null;
    var n = [ "/img/cheese-wine-meat-sm.jpg", "/img/cow-nosey-sm.jpg", "/img/farm_wallpaper-sm.jpg", "/img/crowd2-sm.jpg", "/img/directory-books-sm.jpg", "/img/originals/directory-books.jpg", "/img/originals/crowd2.jpg", "/img/originals/farm_wallpaper.jpg", "/img/originals/cow-nosey.jpg", "/img/originals/cheese-wine-meat.jpg" ], o = !1;
    k.select = a.select = function(c, f) {
        function g() {
            if (!o) {
                if (k.currentSlide && angular.isString(f) && !a.noTransition && c.$element) {
                ...
                } else h(c, k.currentSlide);
                k.currentSlide = c, m = i, e();
            }
        }
        function h(b, c) {
            angular.extend(b, {
        ...
        var i = l.indexOf(c);
        void 0 === f && (f = i > m ? "next" : "prev"), c && c !== k.currentSlide && (a.$currentTransition ? (a.$currentTransition.cancel(), 
        b(g)) : g());
    }, a.$on("$destroy", function() {
        o = !0;
    }), k.indexOfSlide = function(a) {
        return l.indexOf(a);
    }, a.next = function() {
        var b = (m + 1) % l.length;
        return a.$currentTransition ? void 0 : k.select(l[b], "next");
    }, a.prev = function() {
        var b = 0 > m - 1 ? l.length - 1 : m - 1;
        return a.$currentTransition ? void 0 : k.select(l[b], "prev");
    }, a.isActive = function(a) {
        return k.currentSlide === a;
    }, a.$watch("interval", e), a.$on("$destroy", f), a.play = function() {
        j || (j = !0, e());
    }, a.pause = function() {
        a.noPause || (j = !1, f());
    }, h(n), k.addSlide = function(b, c) {
        b.$element = c, l.push(b), 1 === l.length || b.active ? (k.select(l[l.length - 1]), 
        1 == l.length && a.play()) : b.active = !1;
    }, k.removeSlide = function(a) {
        var b = l.indexOf(a);
        l.splice(b, 1), l.length > 0 && a.active ? k.select(b >= l.length ? l[b - 1] : l[b]) : m > b && m--;
    };
    ...
    angular.module("cropme").directive("cropme", [ "$swipe", "$window", "$timeout", "$rootScope", "$q", "elementOffset", "canvasToBlob", function(a, b, c, d, e, f, g) {
        ...
        return i = 100, h = 8, {
            ...
            link: function(b, c) {
                var j, k, l, m, n, o, p, q, r, s, t, u, v, w, x, y, z, A, B, C, D, E, F, G, H;
                return b.dropText = "Drop picture here", b.state = "step-1", q = null, u = null, 
                v = null, H = null, x = c.find("img")[0], k = c.find("canvas")[0], o = k.getContext("2d"), 
                E = function() {
                    return void 0 === b.sendCropped || "true" === b.sendCropped;
                }, F = function() {
                    return "true" === b.sendOriginal;
                }, G = function(a, c) {
                    return H = b.width / a, v = c * H, b.widthCropZone = Math.round(b.destinationWidth * H), 
                    b.heightCropZone = Math.round((b.destinationHeight || i) * H), b.xCropZone = Math.round((b.width - b.widthCropZone) / 2), 
                    b.yCropZone = Math.round((b.height - b.heightCropZone) / 2);
                }, b.checkScopeVariables = function() {
                    return b.width || (b.width = c[0].offsetWidth, b.ratio || b.height || (b.height = c[0].offsetHeight)), 
                    b.destinationHeight && !b.ratio ? b.ratio = b.destinationHeight / b.destinationWidth : b.ratio && (b.destinationHeight = b.destinationWidth * b.ratio), 
                    b.ratio && !b.height && (b.height = b.width * b.ratio), b.type || (b.type = "png"), 
                    b.okLabel || (b.okLabel = "Ok"), b.cancelLabel || (b.cancelLabel = "Cancel"), !0;
                }, w = c[0].getElementsByClassName("step-2")[0], r = function() {
                    return f(w);
                }, j = c.find("input"), j.bind("change", function() {
                    var a;
                    return a = this.files[0], b.$apply(function() {
                        return b.setFiles(a);
                    });
                }), j.bind("click", function(a) {
                    return a.stopPropagation(), j.val("");
                }), b.browseFiles = function() {
                    return j[0].click();
                }, b.setFiles = function(a) {
                    var c;
                    return a.type.match(/^image\//) ? (b.filename = a.name, b.dropError = "", c = new FileReader(), 
                    c.onload = function(a) {
                        return b.$apply(function() {
                            return z(a.target.result);
                        });
                    }, c.readAsDataURL(a)) : b.dropError = "Wrong file type, please select an image.";
                }, z = function(a) {
                    var c;
                    if (a) return b.state = "step-2", a !== b.imgSrc ? (b.imgSrc = a, b.imgLoaded = !1, 
                    c = new Image(), c.onerror = function() {
                        return b.$apply(function() {
                            return b.cancel(), b.dropError = "Unsupported type of image";
                        });
                    }, c.onload = function() {
                        var a, e, f;
                        return f = c.width, e = c.height, a = [], f < b.width && a.push("The image you dropped has a width of " + f + ", but the minimum is " + b.width + "."), 
                        i = Math.min(b.height, b.destinationHeight), i > e && a.push("The image you dropped has a height of " + e + ", but the minimum is " + i + "."), 
                        b.$apply(function() {
                            return a.length ? (b.cancel(), b.dropError = a.join("<br/>")) : (b.imgLoaded = !0, 
                            d.$broadcast("cropme:loaded", f, e), G(f, e));
                        });
                    }, c.crossOrigin = "anonymous", c.src = a) : void 0;
                }, B = function(a) {
                    var c;
                    return c = r(), b.xCropZone = a.x - c.left - b.widthCropZone / 2, b.yCropZone = a.y - c.top - b.heightCropZone / 2, 
                    l();
                }, A = {
                    top: function(a) {
                        var c;
                        return c = a.y - r().top, b.heightCropZone += b.yCropZone - c, b.yCropZone = c, 
                        n(), l();
                    },
                    right: function(a) {
                        var c;
                        return c = a.x - r().left, b.widthCropZone = c - b.xCropZone, m(), l();
                    },
                    bottom: function(a) {
                        var c;
                        return c = a.y - r().top, b.heightCropZone = c - b.yCropZone, n(), l();
                    },
                    left: function(a) {
                        var c;
                        return c = a.x - r().left, b.widthCropZone += b.xCropZone - c, b.xCropZone = c, 
                        m(), l();
                    }
                }, m = function() {
                    return b.ratio ? b.heightCropZone = b.widthCropZone * b.ratio : void 0;
                }, n = function() {
                    return b.ratio ? b.widthCropZone = b.heightCropZone / b.ratio : void 0;
                }, l = function() {
                    return b.xCropZone < 0 && (b.xCropZone = 0), b.yCropZone < 0 && (b.yCropZone = 0), 
                    b.widthCropZone < b.destinationWidth * H ? (b.widthCropZone = b.destinationWidth * H, 
                    m()) : b.destinationHeight && b.heightCropZone < b.destinationHeight * H && (b.heightCropZone = b.destinationHeight * H, 
                    n()), b.xCropZone + b.widthCropZone > b.width && (b.xCropZone = b.width - b.widthCropZone, 
                    b.xCropZone < 0 && (b.widthCropZone = b.width, b.xCropZone = 0, m())), b.yCropZone + b.heightCropZone > v && (b.yCropZone = v - b.heightCropZone, 
                    b.yCropZone < 0) ? (b.heightCropZone = v, b.yCropZone = 0, n()) : void 0;
                }, y = function(a) {
                    var c, d, e, f, g, h, i, j, k;
                    return f = r(), j = b.xCropZone + f.left, k = b.yCropZone + f.top, i = b.widthCropZone, 
                    e = b.heightCropZone, g = {
                        x: j,
                        y: k
                    }, h = {
                        x: j + i,
                        ...
                        x: j + i,
                        y: k + e
                    }, C(a, j, i, k, "top") || D(a, k, e, j + i, "right") || C(a, j, i, k + e, "bottom") || D(a, k, e, j, "left");
                }, C = function(a, b, c, d, e) {
                    return a.x >= b && a.x <= b + c && Math.abs(a.y - d) <= h ? e : void 0;
                }, D = function(a, b, c, d, e) {
                    return a.y >= b && a.y <= b + c && Math.abs(a.x - d) <= h ? e : void 0;
                }, p = function(a) {
                    return q ? b.$apply(function() {
                        return q(a);
                    }) : void 0;
                }, s = function() {
                    var a;
                    return a = e.defer(), E() ? (o.drawImage(x, b.xCropZone / H, b.yCropZone / H, b.croppedWidth, b.croppedHeight, 0, 0, b.destinationWidth, b.destinationHeight), 
                    g(k, function(b) {
                        return a.resolve(b);
                    }, "image/" + b.type)) : a.resolve(), a.promise;
                }, t = function() {
                    var a, c, d;
                    return a = e.defer(), F() ? (c = document.createElement("canvas"), d = c.getContext("2d"), 
                    c.width = x.naturalWidth, c.height = x.naturalHeight, d.drawImage(x, 0, 0), g(c, function(b) {
                        return a.resolve(b);
                    }, "image/" + b.type)) : a.resolve(), a.promise;
                    ...
                    return a && a.preventDefault(), b.dropText = "Drop files here", b.dropClass = "", 
                    b.state = "step-1", delete b.imgSrc, delete b.filename;
                }, b.ok = function(a) {
                    return a && a.preventDefault(), b.croppedWidth = b.widthCropZone / H, b.croppedHeight = b.heightCropZone / H, 
                    e.all([ s(), t() ]).then(function(a) {
                        var c;
                        return c = {
                            x: b.xCropZone / H,
                            y: b.yCropZone / H,
                            ...
                            filename: b.filename
                        }, a[0] && (c.croppedImage = a[0]), a[1] && (c.originalImage = a[1]), d.$broadcast("cropme:done", c, "image/" + b.type, b.id);
                    });
                }, b.$on("cropme:cancel", b.cancel), b.$on("cropme:ok", b.ok), b.$watch("src", function() {
                    var a;
                    return b.src ? (b.filename = b.src, a = b.src.match(/\?/) ? "&" : "?", z("" + b.src + a + "crossOrigin")) : void 0;
                });
            }
        };
    } ]);
    ...
    angular.module("cropme").directive("dropbox", [ "elementOffset", function(a) {
        return {
            ...
            link: function(b, c) {
                var d, e, f, g;
                return f = a(c), g = function(a) {
                    return a.stopPropagation(), a.preventDefault(), b.$apply(function() {
                        return b.dragOver = !1, b.dropText = "Drop files here", b.dropClass = "";
                    });
                }, d = function(a) {
                    return a.x > f.left && a.x < f.left + c[0].offsetWidth && a.y > f.top && a.y < f.top + c[0].offsetHeight ? void 0 : g(a);
                }, e = c[0], b.dropText = "Drop files here", b.dragOver = !1, e.addEventListener("dragenter", d, !1), 
                e.addEventListener("dragleave", d, !1), e.addEventListener("dragover", function(a) {
                    var c;
                    return a.stopPropagation(), a.preventDefault(), c = a.dataTransfer && a.dataTransfer.types && a.dataTransfer.types.indexOf("Files") >= 0, 
                    b.$apply(function() {
                        return b.dragOver = !0, b.dropText = c ? "Drop now" : "Only files are allowed", 
                        b.dropClass = c ? "over" : "not-available";
                    });
                }, !1), e.addEventListener("drop", function(a) {
                    var c;
                    return g(a), c = a.dataTransfer.files, b.$apply(function() {
                        var a, d, e;
                        if (c.length > 0) for (d = 0, e = c.length; e > d; d++) {
                            if (a = c[d], a.type.match(/^image\//)) return b.dropText = "Loading image...", 
                            b.dropClass = "loading", b.setFiles(a);
    ...
    angular.module("cropme").service("canvasToBlob", function() {
        var a, b, c;
        return c = /\s*;\s*base64\s*(?:;|$)/i, a = void 0, b = function(b) {
            var c, d, e, f, g, h, i, j, k, l;
            for (g = b.length, c = new Uint8Array(g / 4 * 3 | 0), e = 0, h = 0, f = [ 0, 0 ], 
            k = 0, j = 0, i = void 0, d = void 0, l = void 0; g--; ) d = b.charCodeAt(e++), 
            i = a[d - 43], 255 !== i && i !== l && (f[1] = f[0], f[0] = d, j = j << 6 | i, k++, 
            4 === k && (c[h++] = j >>> 16, 61 !== f[1] && (c[h++] = j >>> 8), 61 !== f[0] && (c[h++] = j), 
            k = 0));
            return c;
        ...
        function(a, d, e) {
            var f, g, h, i, j, k;
            return e || (e = "image/png"), a.mozGetAsFile ? void d(a.mozGetAsFile("canvas", e)) : (f = Array.prototype.slice.call(arguments, 1), 
            i = a.toDataURL(e), j = i.indexOf(","), h = i.substring(j + 1), k = c.test(i.substring(0, j)), 
            g = void 0, Blob.fake ? (g = new Blob(), g.encoding = k ? "base64" : "URI", g.data = h, 
            g.size = h.length) : Uint8Array && (g = k ? new Blob([ b(h) ], {
                type: e
            }) : new Blob([ decodeURIComponent(h) ], {
                type: e
            })), d(g));
        };
    });
    ...
    angular.module("cropme").service("elementOffset", function() {
        return function(a) {
            var b, c, d, e, f, g;
            for (a[0] && (a = a[0]), d = 0, c = 0, f = 0, e = 0, g = a.offsetWidth, b = a.offsetHeight; a; ) d += a.offsetTop - a.scrollTop, 
            c += a.offsetLeft - a.scrollLeft, a = a.offsetParent;
            return {
                top: d,
                left: c,
                right: c + g,
    ...
    angular.module("cfp.loadingBarInterceptor", [ "cfp.loadingBar" ]).config([ "$httpProvider", function(a) {
        ...
        this.includeSpinner = !0, this.includeBar = !0, this.latencyThreshold = 100, this.startSize = .02, 
        this.parentSelector = "body", this.spinnerTemplate = '<div id="loading-bar-spinner"><div class="spinner-icon"></div></div>', 
        this.loadingBarTemplate = '<div id="loading-bar"><div class="bar"><div class="peg"></div></div></div>', 
        this.$get = [ "$injector", "$document", "$timeout", "$rootScope", function(a, b, c, d) {
            function e() {
                k || (k = a.get("$animate"));
                var e = b.find(n).eq(0);
                c.cancel(m), r || (d.$broadcast("cfpLoadingBar:started"), r = !0, u && k.enter(o, e), 
                t && k.enter(q, e), f(v));
            }
            function f(a) {
                if (r) {
    ...
    this.$get = [ "$rootScope", "$timeout", function(b, c) {
        ...
        return function(c) {
            c = c || {};
            var e = c.ioSocket || io.connect(), f = void 0 === c.prefix ? a : c.prefix, g = c.scope || b, h = function(a, b) {
                e.on(a, b.__ng = d(e, b));
            }, i = function(a, b) {
                ...
                once: i,
                emit: function(a, b, c) {
                    var f = arguments.length - 1, c = arguments[f];
                ...
                forward: function(a, b) {
                    a instanceof Array == !1 && (a = [ a ]), b || (b = g), a.forEach(function(a) {
                        var c = f + a, g = d(e, function() {
                            Array.prototype.unshift.call(arguments, c), b.$broadcast.apply(b, arguments);
                        });
                        b.$on("$destroy", function() {
    ...
    a.module("angulartics.google.analytics", [ "angulartics" ]).config([ "$analyticsProvider", function(b) {
        b.settings.trackRelativePath = !0, b.settings.ga = {
            ...
            window._gaq && _gaq.push([ "_trackPageview", c ]), window.ga && (ga("send", "pageview", c), 
...
}(angular), Date.CultureStrings = Date.CultureStrings || {}, Date.CultureStrings["en-NZ"] = {
    name: "en-NZ",
    ...
    AKDT: "AKDT",
    HADT: "HADT"
}, Date.CultureStrings.lang = "en-NZ", function() {
    var a = Date, b = Date.CultureStrings ? Date.CultureStrings.lang : null, c = {}, d = {
        getFromKey: function(a, b) {
            var c;
            return c = Date.CultureStrings && Date.CultureStrings[b] && Date.CultureStrings[b][a] ? Date.CultureStrings[b][a] : d.buildFromDefault(a), 
            "/" === a.charAt(0) && (c = d.buildFromRegex(a, b)), c;
        },
        getFromObjectValues: function(a, b) {
            var c, e = {};
            for (c in a) a.hasOwnProperty(c) && (e[c] = d.getFromKey(a[c], b));
            return e;
        },
        getFromObjectKeys: function(a, b) {
            var c, e = {};
            for (c in a) a.hasOwnProperty(c) && (e[d.getFromKey(c, b)] = a[c]);
            return e;
        },
        getFromArray: function(a, b) {
            for (var c = [], e = 0; e < a.length; e++) e in a && (c[e] = d.getFromKey(a[e], b));
            return c;
        },
        buildFromDefault: function(a) {
            ...
            switch (a) {
              ...
              default:
                b = a, d = a.split("_"), c = d.length, c > 1 && "/" !== a.charAt(0) && (e = d[c - 1].toLowerCase(), 
                ("initial" === e || "abbr" === e) && (b = d[0]));
            }
            return b;
        },
        buildFromRegex: function(a, b) {
            var c;
            return c = Date.CultureStrings && Date.CultureStrings[b] && Date.CultureStrings[b][a] ? new RegExp(Date.CultureStrings[b][a], "i") : new RegExp(a.replace(new RegExp("/", "g"), ""), "i");
        }
    }, e = function(a, b) {
        for (var c in b) b.hasOwnProperty(c) && (a[c] = b[c]);
    }, f = function(a, e) {
        var f = e ? e : b;
        return c[a] = a, "object" == typeof a ? a instanceof Array ? d.getFromArray(a, f) : d.getFromObjectKeys(a, f) : d.getFromKey(a, f);
    }, g = function(a) {
        var b = Date.Config.i18n + a + ".js", c = document.getElementsByTagName("head")[0] || document.documentElement, d = document.createElement("script");
        d.src = b;
        var e = !1, f = {
            done: function() {}
        };
        return d.onload = d.onreadystatechange = function() {
            e || this.readyState && "loaded" !== this.readyState && "complete" !== this.readyState || (f.done(), 
            c.removeChild(d));
        }, setTimeout(function() {
        ...
        buildFromMethodHash: function(a) {
            var b;
            for (b in a) a.hasOwnProperty(b) && (a[b] = h[a[b]]());
            return a;
        },
        ...
        timeZones: function(a) {
            var b;
            a.timezones = [];
            for (b in a.abbreviatedTimeZoneStandard) a.abbreviatedTimeZoneStandard.hasOwnProperty(b) && a.timezones.push({
                name: b,
                offset: a.abbreviatedTimeZoneStandard[b]
            });
            for (b in a.abbreviatedTimeZoneDST) a.abbreviatedTimeZoneDST.hasOwnProperty(b) && a.timezones.push({
                name: b,
        ...
        }, Date.i18n.currentLanguage()), b = h.buildFromMethodHash({
            dayNames: "days",
    ...
    a.i18n = {
        ...
        setLanguage: function(c, d, e) {
            var f = !1;
            if (d || "en-US" === c || Date.CultureStrings && Date.CultureStrings[c]) b = c, 
            Date.CultureStrings = Date.CultureStrings || {}, Date.CultureStrings.lang = c, Date.CultureInfo = new i(); else if (!Date.CultureStrings || !Date.CultureStrings[c]) if ("undefined" != typeof exports && this.exports !== exports) try {
                require("../i18n/" + c + ".js"), b = c, Date.CultureStrings.lang = c, Date.CultureInfo = new i();
            } catch (h) {
                throw new Error("The DateJS IETF language tag '" + c + "' could not be loaded by Node. It likely does not exist.");
            } else {
                if (!Date.Config || !Date.Config.i18n) return Date.console.error("The DateJS IETF language tag '" + c + "' is not available and has not been loaded."), 
                !1;
                f = !0, g(c).done(function() {
                    b = c, Date.CultureStrings = Date.CultureStrings || {}, Date.CultureStrings.lang = c, 
                    Date.CultureInfo = new i(), a.Parsing.Normalizer.buildReplaceData(), a.Grammar && a.Grammar.buildGrammarFormats(), 
                    e && setTimeout(e, 0);
                });
            }
            a.Parsing.Normalizer.buildReplaceData(), a.Grammar && a.Grammar.buildGrammarFormats(), 
            !f && e && setTimeout(e, 0);
        },
    ...
    var a = Date, b = a.prototype, c = function(a, b) {
        return b || (b = 2), ("000" + a).slice(-1 * b);
    };
    a.console = "undefined" != typeof window && "undefined" != typeof window.console && "undefined" != typeof window.console.log ? console : {
        log: function() {},
        error: function() {}
    }, a.Config = a.Config || {}, a.initOverloads = function() {
        a.now ? a._now || (a._now = a.now) : a._now = function() {
            return new Date().getTime();
        }, a.now = function(b) {
            return b ? a.present() : a._now();
        ...
        }), void 0 === b._toString && (b._toString = b.toString);
    }, a.initOverloads(), a.today = function() {
        return new Date().clearTime();
    }, a.present = function() {
        return new Date();
    }, a.compare = function(a, b) {
        if (isNaN(a) || isNaN(b)) throw new Error(a + " - " + b);
        if (a instanceof Date && b instanceof Date) return b > a ? -1 : a > b ? 1 : 0;
        ...
        for (var b = Date.CultureInfo.dayNames, c = Date.CultureInfo.abbreviatedDayNames, d = Date.CultureInfo.shortestDayNames, e = a.toLowerCase(), f = 0; f < b.length; f++) if (b[f].toLowerCase() === e || c[f].toLowerCase() === e || d[f].toLowerCase() === e) return f;
        return -1;
        ...
        return !c && a.validateMonth(b) && (c = b, b = Date.today().getFullYear()), [ 31, a.isLeapYear(b) ? 29 : 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31 ][c];
        ...
        for (c in d) if (d.hasOwnProperty(c) && d[c] === a) return c;
        return null;
    }, a.getTimezoneOffset = function(a, b) {
        var c, d = [], e = Date.CultureInfo.timezones;
        for (a || (a = new Date().getTimezone()), c = 0; c < e.length; c++) e[c].name === a.toUpperCase() && d.push(c);
        if (!e[d[0]]) return null;
        if (1 === d.length || !b) return e[d[0]].offset;
        for (c = 0; c < d.length; c++) if (e[d[c]].dst) return e[d[c]].offset;
        ...
        a = a || new Date();
        var b = new Date(a);
        return b.setMonth(b.getMonth() + 3 - b.getMonth() % 3, 0), Math.floor((b - a) / 864e5);
    };
    var d = function(a, b, c, d) {
        if (d = d ? d : "Object", "undefined" == typeof a) return !1;
    ...
    a.validateMillisecond = function(a) {
        ...
        return void 0 === c || null === c || void 0 === e || null === e ? !1 : d(b, 1, a.getDaysInMonth(c, e), "day");
    ...
    var a = Date, b = a.prototype, c = function(a, b) {
        ...
        d = function(c, d, e) {
            if ("day" === c) {
                var g = void 0 !== b.month ? b.month : f.getMonth(), h = void 0 !== b.year ? b.year : f.getFullYear();
                return a[d](e, h, g);
            }
            return a[d](e);
        };
        for (c in b) if (hasOwnProperty.call(b, c)) {
            var g = "validate" + c.charAt(0).toUpperCase() + c.slice(1);
            a[g] && null !== b[c] && d(c, g, b[c]) && (e[c] = b[c]);
        }
        return e;
    };
    b.clearTime = function() {
        ...
        var a = new Date();
        return this.setHours(a.getHours()), this.setMinutes(a.getMinutes()), this.setSeconds(a.getSeconds()), 
        this.setMilliseconds(a.getMilliseconds()), this;
    }, b.clone = function() {
        return new Date(this.getTime());
    }, b.compareTo = function(a) {
        return Date.compare(this, a);
    }, b.equals = function(a) {
        return Date.equals(this, void 0 !== a ? a : new Date());
        ...
        return a ? (this.setTime(this.getTime() + 1 * a), this) : this;
    }, b.addSeconds = function(a) {
        return a ? this.addMilliseconds(1e3 * a) : this;
    }, b.addMinutes = function(a) {
        return a ? this.addMilliseconds(6e4 * a) : this;
    }, b.addHours = function(a) {
        return a ? this.addMilliseconds(36e5 * a) : this;
    }, b.addDays = function(a) {
        return a ? (this.setDate(this.getDate() + 1 * a), this) : this;
    }, b.addWeekdays = function(a) {
        if (!a) return this;
        var b = this.getDay(), c = Math.ceil(Math.abs(a) / 7);
        if ((0 === b || 6 === b) && a > 0 && (this.next().monday(), this.addDays(-1), b = this.getDay()), 
        0 > a) {
            for (;0 > a; ) this.addDays(-1), b = this.getDay(), 0 !== b && 6 !== b && a++;
            return this;
        }
        return (a > 5 || a >= 6 - b) && (a += 2 * c), this.addDays(a);
    }, b.addWeeks = function(a) {
        return a ? this.addDays(7 * a) : this;
    }, b.addMonths = function(b) {
        if (!b) return this;
        var c = this.getDate();
        return this.setDate(1), this.setMonth(this.getMonth() + 1 * b), this.setDate(Math.min(c, a.getDaysInMonth(this.getFullYear(), this.getMonth()))), 
        this;
    }, b.addQuarters = function(a) {
        return a ? this.addMonths(3 * a) : this;
    }, b.addYears = function(a) {
        return a ? this.addMonths(12 * a) : this;
    }, b.add = function(a) {
        if ("number" == typeof a) return this._orient = a, this;
        var b = a;
        return b.day && b.day - this.getDate() !== 0 && this.setDate(b.day), b.milliseconds && this.addMilliseconds(b.milliseconds), 
        b.seconds && this.addSeconds(b.seconds), b.minutes && this.addMinutes(b.minutes), 
        b.hours && this.addHours(b.hours), b.weeks && this.addWeeks(b.weeks), b.months && this.addMonths(b.months), 
        b.years && this.addYears(b.years), b.days && this.addDays(b.days), this;
    }, b.getWeek = function(a) {
        var b, c = new Date(this.valueOf());
        a ? (c.addMinutes(c.getTimezoneOffset()), b = c.clone()) : b = this;
        var d = (b.getDay() + 6) % 7;
        c.setDate(c.getDate() - d + 3);
        var e = c.valueOf();
        return c.setMonth(0, 1), 4 !== c.getDay() && c.setMonth(0, 1 + (4 - c.getDay() + 7) % 7), 
        1 + Math.ceil((e - c) / 6048e5);
    }, b.getISOWeek = function() {
        return c(this.getWeek(!0));
    }, b.setWeek = function(a) {
        return a - this.getWeek() === 0 ? 1 !== this.getDay() ? this.moveToDayOfWeek(1, this.getDay() > 1 ? -1 : 1) : this : this.moveToDayOfWeek(1, this.getDay() > 1 ? -1 : 1).addWeeks(a - this.getWeek());
    }, b.setQuarter = function(a) {
        var b = Math.abs(3 * (a - 1) + 1);
        ...
        if ("Weekday" === a) {
            if (b > 0) this.moveToFirstDayOfMonth(), this.is().weekday() && (b -= 1); else {
                if (!(0 > b)) return this;
                this.moveToLastDayOfMonth(), this.is().weekday() && (b += 1);
            }
            return this.addWeekdays(b);
        }
        var c = 0;
        if (b > 0) c = b - 1; else if (-1 === b) return this.moveToLastDayOfMonth(), this.getDay() !== a && this.moveToDayOfWeek(a, -1), 
        this;
    ...
    var e = function(a, b, c) {
        return function(d, e) {
            ...
            return this[b](0 === f ? f += c * (e || 1) : f);
        };
    };
    b.moveToDayOfWeek = e("getDay", "addDays", 7), b.moveToMonth = e("getMonth", "addMonths", 12), 
    b.getOrdinate = function() {
        ...
        return c || 0 === c ? this.addMinutes(c - b) : this;
        ...
        var b, c = -10 * (a || this.getTimezoneOffset()) / 6;
        return 0 > c ? (b = (c - 1e4).toString(), b.charAt(0) + b.substr(2)) : (b = (c + 1e4).toString(), 
        "+" + b.substr(1));
        ...
        a = d.call(this, a);
        var b;
        for (b in a) if (hasOwnProperty.call(a, b)) {
            var c, e, f = b.charAt(0).toUpperCase() + b.slice(1);
            "week" !== b && "month" !== b && "timezone" !== b && "timezoneOffset" !== b && (f += "s"), 
            c = "add" + f, e = "get" + f, "month" === b ? c += "s" : "year" === b && (e = "getFullYear"), 
            "day" !== b && "timezone" !== b && "timezoneOffset" !== b && "week" !== b && "hour" !== b ? this[c](a[b] - this[e]()) : ("timezone" === b || "timezoneOffset" === b || "week" === b || "hour" === b) && this["set" + f](a[b]);
        }
        return a.day && this.addDays(a.day - this.getDate()), this;
    ...
    var f = function(a) {
        ...
        switch (a) {
          ...
          case "r":
          case "R":
            return b = this.clone().addMinutes(this.getTimezoneOffset()), b.toString(c.rfc1123) + " GMT";
          ...
          case "u":
            return b = this.clone().addMinutes(this.getTimezoneOffset()), b.toString(c.universalSortableDateTime);
        ...
        return function(d) {
            ...
            switch (d) {
              case "hh":
                return c(b.getHours() < 13 ? 0 === b.getHours() ? 12 : b.getHours() : b.getHours() - 12);

              case "h":
                return b.getHours() < 13 ? 0 === b.getHours() ? 12 : b.getHours() : b.getHours() - 12;
              ...
              case "B":
                return "@" + (b.getUTCSeconds() + 60 * b.getUTCMinutes() + 3600 * (b.getUTCHours() + 1)) / 86.4;
    ...
    b.toString = function(a, b) {
        if (!b && a && 1 === a.length && (output = g.call(this, a))) return output;
        var c = h(this);
    ...
    b._orient = 1, b._nth = null, b._is = !1, b._same = !1, b._isSecond = !1, c._dateElement = "days", 
    b.next = function() {
        ...
        return this._nth ? j("Weekday").call(this) : this._move ? this.addWeekdays(this._orient) : this._is ? (this._is = !1, 
        !this.is().sat() && !this.is().sun()) : !1;
    }, b.weekend = function() {
        return this._is ? (this._is = !1, this.is().sat() || this.is().sun()) : !1;
    }, b.at = function(b) {
        return "string" == typeof b ? a.parse(this.toString("d") + " " + b) : this.set(b);
    }, c.fromNow = c.after = function(a) {
        var b = {};
        return b[this._dateElement] = this, (a ? a.clone() : new Date()).add(b);
    }, c.ago = c.before = function(a) {
        var b = {}, c = "s" !== this._dateElement[this._dateElement.length - 1] ? this._dateElement + "s" : this._dateElement;
        return b[c] = -1 * this, (a ? a.clone() : new Date()).add(b);
    };
    var d, e = "sunday monday tuesday wednesday thursday friday saturday".split(/\s/), f = "january february march april may june july august september october november december".split(/\s/), g = "Millisecond Second Minute Hour Day Week Month Year Quarter Weekday".split(/\s/), h = "Milliseconds Seconds Minutes Hours Date Week Month FullYear Quarter".split(/\s/), i = "final first second third fourth fifth".split(/\s/);
    b.toObject = function() {
        for (var a = {}, b = 0; b < g.length; b++) this["get" + h[b]] && (a[g[b].toLowerCase()] = this["get" + h[b]]());
        return a;
    }, a.fromObject = function(a) {
        return a.week = null, Date.today().set(a);
    };
    var j = function(b) {
        return function() {
            ...
            if (this._move && (this._move = null), null !== this._nth) {
                ...
                if (this.moveToNthOccurrence(b, c), this > d) throw new RangeError(a.getDayName(b) + " does not occur " + c + " times in the month of " + a.getMonthName(d.getMonth()) + " " + d.getFullYear() + ".");
                return this;
            }
        ...
        return function() {
            ...
            return 0 === b && 1 === Date.CultureInfo.firstDayOfWeek && 0 !== c.getDay() && (d += 7), 
            c.addDays(d);
        };
    }, l = function(a) {
        return function() {
        ...
        for (var f = 0; f < c.length; f++) a[c[f].toUpperCase()] = a[c[f].toUpperCase().substring(0, 3)] = f, 
        a[c[f]] = a[c[f].substring(0, 3)] = d(f), b[c[f]] = b[c[f].substring(0, 3)] = e(f);
    };
    n(e, k, j), n(f, m, l);
    for (var o = function(a) {
        return function() {
            ...
            if (this._same) {
                ...
                e = "s" === e[e.length - 1] ? e.substring(0, e.length - 1) : e;
                for (var f = g.length - 1; f > -1; f--) {
                    if (d = g[f].toLowerCase(), b[d] !== c[d]) return !1;
                    if (e === d) break;
                }
                return !0;
            }
            return "s" !== a.substring(a.length - 1) && (a += "s"), this._move && (this._move = null), 
    ...
    }, q = 0; q < g.length; q++) d = g[q].toLowerCase(), "weekday" !== d && (b[d] = b[d + "s"] = o(g[q]), 
    c[d] = c[d + "s"] = p(d + "s"));
    b._ss = o("Second");
    for (var r = function(a) {
        return function(b) {
            return this._same ? this._ss(arguments[0]) : b || 0 === b ? this.moveToNthOccurrence(b, a) : (this._nth = a, 
            2 !== a || void 0 !== b && null !== b ? this : (this._isSecond = !0, this.addSeconds(this._orient)));
        };
    }, s = 0; s < i.length; s++) b[i[s]] = r(0 === s ? -1 : s);
}(), function() {
    "use strict";
    Date.Parsing = {
    ...
    var c = {
        multiReplace: function(a, b) {
            ...
            for (c in b) if (Object.prototype.hasOwnProperty.call(b, c)) {
                var d;
                "function" == typeof b[c] || (d = b[c] instanceof RegExp ? b[c] : new RegExp(b[c], "g")), 
                a = a.replace(d, c);
            }
            return a;
        },
        getDayOfYearFromWeek: function(a) {
            var b, c, d;
            return a.weekDay = a.weekDay || 0 === a.weekDay ? a.weekDay : 1, b = new Date(a.year, 0, 4), 
            c = 0 === b.getDay() ? 7 : b.getDay(), d = c + 3, a.dayOfYear = 7 * a.week + (0 === a.weekDay ? 7 : a.weekDay) - d, 
            a;
        },
        getDayOfYear: function(a, b) {
            a.dayOfYear || (a = c.getDayOfYearFromWeek(a));
        ...
        adjustForTimeZone: function(a, b) {
            var c;
            return "Z" === a.zone.toUpperCase() || 0 === a.zone_hours && 0 === a.zone_minutes ? c = -b.getTimezoneOffset() : (c = 60 * a.zone_hours + (a.zone_minutes || 0), 
            "+" === a.zone_sign && (c *= -1), c -= b.getTimezoneOffset()), b.setMinutes(b.getMinutes() + c), 
            b;
        },
        setDefaults: function(a) {
            return a.year = a.year || Date.today().getFullYear(), a.hours = a.hours || 0, a.minutes = a.minutes || 0, 
            a.seconds = a.seconds || 0, a.milliseconds = a.milliseconds || 0, (a.month || !a.week && !a.dayOfYear) && (a.month = a.month || 0, 
            a.day = a.day || 1), a;
        },
        dataNum: function(a, b, c, d) {
            var e = 1 * a;
            return b ? d ? a ? 1 * b(a) : a : a ? b(e) : a : c ? a && "undefined" != typeof a ? e : a : a ? e : a;
        },
        timeDataProcess: function(a) {
            var b = {};
            for (var d in a.data) a.data.hasOwnProperty(d) && (b[d] = a.ignore[d] ? a.data[d] : c.dataNum(a.data[d], a.mods[d], a.explict[d], a.postProcess[d]));
            return a.data.secmins && (a.data.secmins = 60 * a.data.secmins.replace(",", "."), 
            b.minutes ? b.seconds || (b.seconds = a.data.secmins) : b.minutes = a.data.secmins, 
            delete a.secmins), b;
        },
        buildTimeObjectFromData: function(a) {
            var b = c.timeDataProcess({
                ...
                mods: {
                    ...
                    weekDay: function(a) {
                        return a = Math.abs(a), 7 === a ? 0 : a;
                    },
                    minutes: function(a) {
                        return a.replace(":", "");
                    },
                    seconds: function(a) {
                        return Math.floor(1 * a.replace(":", "").replace(",", "."));
                    },
                    milliseconds: function(a) {
                        return 1e3 * a.replace(",", ".");
                    }
                },
                postProcess: {
                    minutes: !0,
        ...
        addToHash: function(a, b, c) {
            b = b, c = c;
            for (var d = b.length, e = 0; d > e; e++) a[b[e]] = c[e];
            return a;
        },
        ...
        getDateNthString: function(a, b, c) {
            return a ? Date.today().addDays(c).toString("d") : b ? Date.today().last()[c]().toString("d") : void 0;
        },
        buildRegexData: function(a) {
            for (var b = [], c = a.length, d = 0; c > d; d++) b.push("[object Array]" === Object.prototype.toString.call(a[d]) ? this.combineRegex(a[d][0], a[d][1]) : a[d]);
            return b;
        }
    };
    a.processTimeObject = function(d) {
        var e, f;
        return c.setDefaults(d), f = a.isLeapYear(d.year) ? b.leap : b.standard, d.month || !d.week && !d.dayOfYear ? d.dayOfYear = f[d.month] + d.day : c.getDayOfYear(d, f), 
        e = new Date(d.year, d.month, d.day, d.hours, d.minutes, d.seconds, d.milliseconds), 
        d.zone && c.adjustForTimeZone(d, e), e;
    }, a.ISO = {
        regex: /^([\+-]?\d{4}(?!\d{2}\b))((-?)((0[1-9]|1[0-2])(\3([12]\d|0[1-9]|3[01]))?|W([0-4]\d|5[0-3])(-?[1-7])?|(00[1-9]|0[1-9]\d|[12]\d{2}|3([0-5]\d|6[1-6])))([T\s]((([01]\d|2[0-4])((:?)[0-5]\d)?|24\:?00)([\.,]\d+(?!:))?)?(\17[0-5]\d([\.,]\d+)?)?\s?([zZ]|([\+-])([01]\d|2[0-3]):?([0-5]\d)?)?)?)?$/,
        parse: function(b) {
            var d, e = b.match(this.regex);
            return e && e.length ? (d = c.buildTimeObjectFromData(e), d.year && (d.year || d.month || d.day || d.week || d.dayOfYear) ? a.processTimeObject(d) : null) : null;
        }
    }, a.Numeric = {
        ...
        parse: function(b) {
            ...
            if (!this.isNumeric(b) || "+" === b[0] && "-" === b[0]) return null;
            if (b.length < 5 && b.indexOf(".") < 0 && b.indexOf("/") < 0) return e.year = b, 
            a.processTimeObject(e);
            if (c = b.match(this.regex), !c || !c.length) return null;
            for (d = 0; d < f.length; d++) switch (f[d]) {
              case "d":
                e.day = c[d + 1];
                break;
        ...
        keys: function() {
            return [ c.getDateNthString(!0, !1, 1), c.getDateNthString(!0, !1, -1), c.getDateNthString(!1, !0, "monday"), c.getDateNthString(!1, !0, "tuesday"), c.getDateNthString(!1, !0, "wednesday"), c.getDateNthString(!1, !0, "thursday"), c.getDateNthString(!1, !0, "friday"), c.getDateNthString(!1, !0, "saturday"), c.getDateNthString(!1, !0, "sunday") ];
        },
        buildRegexFunctions: function() {
            var a = Date.CultureInfo.regexPatterns, b = Date.i18n.__, c = new RegExp("(\\b\\d\\d?(" + b("AM") + "|" + b("PM") + ")? )(" + a.tomorrow.source.slice(1) + ")", "i"), d = new RegExp(a.today.source + "(?!\\s*([+-]))\\b");
        ...
        buildReplaceData: function() {
            this.buildRegexFunctions(), this.replaceHash = c.addToHash(this.basicReplaceHash(), this.keys(), this.regexData());
        },
        stringReplaceFuncs: function(a) {
            for (var b = 0; b < this.replaceFuncs.length; b++) a = a.replace(this.replaceFuncs[b][0], this.replaceFuncs[b][1]);
            return a;
        },
        parse: function(b) {
            b = this.stringReplaceFuncs(b), b = c.multiReplace(b, this.replaceHash);
            try {
                var d = b.split(/([\s\-\.\,\/\x27]+)/);
                3 === d.length && a.Numeric.isNumeric(d[0]) && a.Numeric.isNumeric(d[2]) && d[2].length >= 4 && "d" === Date.CultureInfo.dateElementOrder[0] && (b = "1/" + d[0] + "/" + d[2]);
            } catch (e) {}
            return b;
        }
    ...
    for (var a = Date.Parsing, b = a.Operators = {
        ...
        cache: function(b) {
            var c = {}, d = 0, e = [], f = Date.Config.CACHE_MAX || 1e5, g = null, h = function() {
                if (d === f) for (var a = 0; 10 > a; a++) {
                    var b = e.shift();
                    b && (delete c[b], d--);
                }
            };
            return function(f) {
                ...
                if (d++, e.push(f), g instanceof a.Exception) throw g;
                return g;
            };
        },
        any: function() {
            ...
            return d = d || b.rtoken(/^\s*/), e = e || null, function(f) {
                for (var g = null, h = null, i = null, j = null, k = [ [], f ], l = !1, m = 0; m < c.length; m++) {
                    ...
                    if (l || 0 !== i[1].length || (l = !0), !l) {
                        ...
                        h = b.set(p, d).call(this, i[1]), h[0].length > 0 && (j[0] = j[0].concat(h[0]), 
                        j[1] = h[1]);
                    }
        ...
        function b() {
            var b, c, d = null, e = [];
            return arguments.length > 1 ? d = Array.prototype.slice.call(arguments) : arguments[0] instanceof Array && (d = arguments[0]), 
            d ? (b = d.shift(), b.length > 0 ? (d.unshift(b[c]), e.push(a.apply(null, d)), d.shift(), 
            e) : void 0) : a.apply(null, arguments);
        }
        return b;
    ...
    var a = Date, b = function(a) {
        ...
        var a = new Date();
        !this.hour && !this.minute || this.month || this.year || this.day || (this.day = a.getDate()), 
        this.year || (this.year = a.getFullYear()), this.month || 0 === this.month || (this.month = a.getMonth()), 
        ...
        getToday: function() {
            return this.now || -1 !== "hour minute second".indexOf(this.unit) ? new Date() : a.today();
        },
        setDaysFromWeekday: function(b, c) {
            var d;
            return c = c || 1, this.unit = "day", d = a.getDayNumberFromName(this.weekday) - b.getDay(), 
            this.days = d ? (d + 7 * c) % 7 : 7 * c, this;
        },
        setMonthsFromMonth: function(a, b) {
            var c;
            return b = b || 1, this.unit = "month", c = this.month - a.getMonth(), this.months = c ? (c + 12 * b) % 12 : 12 * b, 
            this.month = null, this;
        },
        setDMYFromWeekday: function() {
            var a = Date[this.weekday]();
            return this.day = a.getDate(), this.month || (this.month = a.getMonth()), this.year = a.getFullYear(), 
            this;
        },
        setUnitValue: function(a) {
            !this.value && this.operator && null !== this.operator && this[this.unit + "s"] && null !== this[this.unit + "s"] ? this[this.unit + "s"] = this[this.unit + "s"] + ("add" === this.operator ? 1 : -1) + (this.value || 0) * a : (null == this[this.unit + "s"] || null != this.operator) && (this.value || (this.value = 1), 
            this[this.unit + "s"] = this.value * a);
        },
        generateDateFromWeeks: function() {
            var a = void 0 !== this.weekday ? this.weekday : "today", b = Date[a]().addWeeks(this.weeks);
            return this.now && b.setTimeToNow(), b;
        }
    };
    a.Translator = {
        hour: function(a) {
        ...
        secondAndMillisecond: function(a) {
            return function() {
                ...
                this.second = Number(b[1]), this.millisecond = Number(b[2]);
            };
        },
        meridian: function(a) {
            return function() {
        ...
        day: function(a) {
            var b = a[0];
            return function() {
                if (this.day = Number(b.match(/\d+/)[0]), this.day < 1) throw "invalid day";
            };
        },
        month: function(a) {
            return function() {
                if (this.month = 3 === a.length ? "jan feb mar apr may jun jul aug sep oct nov dec".indexOf(a) / 4 : Number(a) - 1, 
        ...
        finishExact: function(b) {
            ...
            for (var f = 0; f < b.length; f++) b[f] && b[f].call(this);
            if (d.call(this), c.call(this), this.day > a.getDaysInMonth(this.year, this.month)) throw new RangeError(this.day + " is not a valid value for days.");
            return e = new Date(this.year, this.month, this.day, this.hour, this.minute, this.second, this.millisecond), 
            this.year < 100 && e.setFullYear(this.year), this.timezone ? e.set({
                timezone: this.timezone
            }) : this.timezoneOffset && e.set({
                timezoneOffset: this.timezoneOffset
            }), e;
        },
        finish: function(d) {
            var f, g, h, i;
            if (d = d instanceof Array ? b(d) : [ d ], 0 === d.length) return null;
            for (var j = 0; j < d.length; j++) "function" == typeof d[j] && d[j].call(this);
            if (this.now && !this.unit && !this.operator) return new Date();
            if (f = e.getToday.call(this), g = !!(this.days && null !== this.days || this.orient || this.operator), 
            h = "past" === this.orient || "subtract" === this.operator ? -1 : 1, this.month && "week" === this.unit && (this.value = this.month + 1, 
            ...
            this.month = null, g = !0), g || !this.weekday || this.day || this.days || e.setDMYFromWeekday.call(this), 
            g && this.weekday && "month" !== this.unit && "week" !== this.unit && e.setDaysFromWeekday.call(this, f, h), 
            !this.weekday || "week" === this.unit || this.day || this.days || (i = Date[this.weekday](), 
            this.day = i.getDate(), i.getMonth() !== f.getMonth() && (this.month = i.getMonth())), 
            ...
            this.month && !this.day && this.value && (f.set({
                day: 1 * this.value
            }), g || (this.day = 1 * this.value)), this.month || !this.value || "month" !== this.unit || this.now || (this.month = this.value, 
            g = !0), g && (this.month || 0 === this.month) && "year" !== this.unit && e.setMonthsFromMonth.call(this, f, h), 
            this.unit || (this.unit = "day"), e.setUnitValue.call(this, h), c.call(this), !this.month && 0 !== this.month || this.day || (this.day = 1), 
            !this.orient && !this.operator && "week" === this.unit && this.value && !this.day && !this.month) return Date.today().setWeek(this.value);
            if ("week" === this.unit && this.weeks && !this.day && !this.month) return e.generateDateFromWeeks.call(this);
            if (g && this.timezone && this.day && this.days && (this.day = this.days), g ? f.add(this) : f.set(this), 
            this.timezone) {
                this.timezone = this.timezone.toUpperCase();
                var k, l = a.getTimezoneOffset(this.timezone);
                f.hasDaylightSavingTime() && (k = a.getTimezoneAbbreviation(l, f.isDaylightSavingTime()), 
                k !== this.timezone && f.addHours(f.isDaylightSavingTime() ? -1 : 1)), f.setTimezoneOffset(l);
            }
            return f;
        }
    };
    ...
    var a = Date;
    a.Grammar = {};
    var b, c = a.Parsing.Operators, d = a.Grammar, e = a.Translator;
    b = function() {
        return c.each(c.any.apply(null, arguments), c.not(d.ctoken2("timeContext")));
    }, d.datePartDelimiter = c.rtoken(/^([\s\-\.\,\/\x27]+)/), d.timePartDelimiter = c.stoken(":"), 
    d.whiteSpace = c.rtoken(/^\s*/), d.generalDelimiter = c.rtoken(/^(([\s\,]|at|@|on)+)/);
    var f = {};
    d.ctoken = function(a) {
        var b = f[a];
        if (!b) {
    ...
    var g = function(a, b, e, f) {
        d[a] = c.cache(f ? c.process(c.each(c.rtoken(b), c.optional(d.ctoken2(f))), e) : c.process(c.rtoken(b), e));
    }, h = function(a, b) {
        return c.cache(c.process(d.ctoken2(a), b));
    }, i = {}, j = function(a) {
        return i[a] = i[a] || d.format(a)[0], i[a];
    };
    d.allformats = function(a) {
        var b = [];
        if (a instanceof Array) for (var c = 0; c < a.length; c++) b.push(j(a[c])); else b.push(j(a));
        return b;
    }, d.formats = function(a) {
        if (a instanceof Array) {
            for (var b = [], d = 0; d < a.length; d++) b.push(j(a[d]));
    ...
    var k = {
        timeFormats: function() {
            ...
            for (a = 0; a < b.length; a++) g(b[a], f[a], i[a]);
            d.hms = c.cache(c.sequence([ d.H, d.m, d.s ], d.timePartDelimiter)), d.t = h("shortMeridian", e.meridian), 
            d.tt = h("longMeridian", e.meridian), d.zzz = h("timezone", e.timezone), d.timeSuffix = c.each(c.ignore(d.whiteSpace), c.set([ d.tt, d.zzz ])), 
            d.time = c.each(c.optional(c.ignore(c.stoken("T"))), d.hms, d.timeSuffix);
        },
        dateFormats: function() {
            var a, f = function() {
                return c.set(arguments, d.datePartDelimiter);
            }, h = [ "d", "dd", "M", "MM", "y", "yy", "yyy", "yyyy" ], i = [ /^([0-2]\d|3[0-1]|\d)/, /^([0-2]\d|3[0-1])/, /^(1[0-2]|0\d|\d)/, /^(1[0-2]|0\d)/, /^(\d+)/, /^(\d\d)/, /^(\d\d?\d?\d?)/, /^(\d\d\d\d)/ ], j = [ e.day, e.day, e.month, e.month, e.year, e.year, e.year, e.year ], k = [ "ordinalSuffix", "ordinalSuffix" ];
            for (a = 0; a < h.length; a++) g(h[a], i[a], j[a], k[a]);
            ...
            })), d.day = b(d.d, d.dd), d.month = b(d.M, d.MMM), d.year = b(d.yyyy, d.yy), d.mdy = f(d.ddd, d.month, d.day, d.year), 
            d.ymd = f(d.ddd, d.year, d.month, d.day), d.dmy = f(d.ddd, d.day, d.month, d.year), 
            d.date = function(a) {
        ...
        relative: function() {
            ...
            }), d.rday = c.process(d.ctoken("yesterday tomorrow today now"), e.rday), d.unit = c.process(d.ctoken("second minute hour day week month year"), function(a) {
                return function() {
                    this.unit = a;
                };
            });
    ...
    d.buildGrammarFormats = function() {
        f = {}, k.timeFormats(), k.dateFormats(), k.relative(), d.value = c.process(c.rtoken(/^([-+]?\d+)?(st|nd|rd|th)?/), function(a) {
            return function() {
                this.value = a.replace(/\D/g, "");
            };
        }), d.expression = c.set([ d.rday, d.operator, d.value, d.unit, d.orientation, d.ddd, d.MMM ]), 
        d.format = c.process(c.many(c.any(c.process(c.rtoken(/^(dd?d?d?(?!e)|MM?M?M?|yy?y?y?|hh?|HH?|mm?|ss?|tt?|zz?z?)/), function(b) {
            if (d[b]) return d[b];
    ...
    function a(a) {
        var d;
        return a ? a instanceof Date ? a.clone() : (a.length >= 4 && "0" !== a.charAt(0) && "+" !== a.charAt(0) && "-" !== a.charAt(0) && (d = b.Parsing.ISO.parse(a) || b.Parsing.Numeric.parse(a)), 
        d instanceof Date && !isNaN(d.getTime()) ? d : (a = b.Parsing.Normalizer.parse(c.removeOrds(a)), 
        d = c.grammarParser(a), null !== d ? d : c.nativeFallback(a))) : null;
    }
    var b = Date, c = {
        removeOrds: function(a) {
            return ords = a.match(/\b(\d+)(?:st|nd|rd|th)\b/), a = ords && 2 === ords.length ? a.replace(ords[0], ords[1]) : a;
        },
        grammarParser: function(a) {
            var c = null;
            try {
                c = b.Grammar.start.call({}, a.replace(/^\s*(\S*(\s+\S+)*)\s*$/, "$1"));
            } catch (d) {
                return null;
            }
        ...
        nativeFallback: function(a) {
            var b;
            try {
                return b = Date._parse(a), b || 0 === b ? new Date(b) : null;
            } catch (c) {
                return null;
            }
        }
    };
    b._parse || (b._parse = b.parse), b.parse = a, Date.getParseFunction = function(a) {
        ...
        return function(a) {
            for (var c = null, d = 0; d < b.length; d++) {
                ...
                if (0 === c[1].length) return c[0];
            }
            return null;
        };
    }, b.parseExact = function(a, c) {
        return b.getParseFunction(c)(a);
    };
}(), function() {
    var a = Date, b = a.prototype, c = function(a, b) {
        return b || (b = 2), ("000" + a).slice(-1 * b);
        ...
        interpreted: function(b, d) {
            ...
            switch (b) {
              ...
              case "%U":
                ...
                return f > g ? "00" : c((g.getOrdinalNumber() - f.getOrdinalNumber()) / 7 + 1);
              ...
              case "P":
                return e = d.getUTCOffset(), e.substring(0, e.length - 2) + ":" + e.substring(e.length - 2);

              case "B":
                var h = new Date();
                return Math.floor((3600 * h.getHours() + 60 * h.getMinutes() + h.getSeconds() + 60 * (h.getTimezoneOffset() + 60)) / 86.4);
        ...
        parse: function(a, b) {
            var c, d = b || new Date();
            return (c = e.substitutes(a)) ? c : (c = e.interpreted(a, d), c ? c : a);
        }
    };
    ...
    var f = function(b) {
        return function(c) {
            var d, f = !1;
            return "\\" === c.charAt(0) || "%%" === c.substring(0, 2) ? c.replace("\\", "").replace("%%", "%") : (f = e.shouldOverrideDefaults(c), 
            d = a.normalizeFormat(c, b), d ? b.toString(d, f) : void 0);
        };
    };
    b._format = function(a) {
        var b = f(this);
        return a ? a.replace(/(%|\\)?.|%%/g, b) : this._toString();
    }, b.format || (b.format = b._format);
}(), function() {
    "use strict";
    var a = function(a) {
        return function() {
        ...
        for (var e = 0; e < d.length; e++) {
            ...
            c.prototype[f] = 0, c.prototype["get" + g] = a(f), c.prototype["set" + g] = b(f);
        }
    }, e = function(a, b, c, d, f) {
        if (1 === arguments.length && "number" == typeof a) {
            var g = 0 > a ? -1 : 1, h = Math.abs(a);
            this.setDays(Math.floor(h / 864e5) * g), h %= 864e5, this.setHours(Math.floor(h / 36e5) * g), 
            h %= 36e5, this.setMinutes(Math.floor(h / 6e4) * g), h %= 6e4, this.setSeconds(Math.floor(h / 1e3) * g), 
            h %= 1e3, this.setMilliseconds(h * g);
        } else this.set(a, b, c, d, f);
        return this.getTotalMilliseconds = function() {
            ...
            var b, c = new Date(1970, 1, 1, this.getHours(), this.getMinutes(), this.getSeconds());
            return b = null === a ? new Date(1970, 1, 1, 0, 0, 0) : new Date(1970, 1, 1, a.getHours(), a.getMinutes(), a.getSeconds()), 
            b > c ? -1 : c > b ? 1 : 0;
        }, this.equals = function(a) {
            return 0 === this.compareTo(a);
        }, this.add = function(a) {
            return null === a ? this : this.addSeconds(a.getTotalMilliseconds() / 1e3);
        }, this.subtract = function(a) {
            return null === a ? this : this.addSeconds(-a.getTotalMilliseconds() / 1e3);
        }, this.addDays = function(a) {
            return new e(this.getTotalMilliseconds() + 864e5 * a);
        }, this.addHours = function(a) {
            return new e(this.getTotalMilliseconds() + 36e5 * a);
        }, this.addMinutes = function(a) {
            return new e(this.getTotalMilliseconds() + 6e4 * a);
        }, this.addSeconds = function(a) {
            return new e(this.getTotalMilliseconds() + 1e3 * a);
    ...
    d(e, c.slice(2)), e.prototype.set = function(a, b, c, d, e) {
        this.setDays(a || this.getDays()), this.setHours(b || this.getHours()), this.setMinutes(c || this.getMinutes()), 
        this.setSeconds(d || this.getSeconds()), this.setMilliseconds(e || this.getMilliseconds());
    }, Date.prototype.getTimeOfDay = function() {
        return new e(0, this.getHours(), this.getMinutes(), this.getSeconds(), this.getMilliseconds());
    }, Date.TimeSpan = e, "undefined" != typeof window && (window.TimeSpan = e);
}(), function() {
    "use strict";
    var a = [ "years", "months", "days", "hours", "minutes", "seconds", "milliseconds" ], b = function(a) {
        return function() {
            return this[a];
        };
    }, c = function(a) {
        ...
        for (var e = 0; e < d.length; e++) {
            var f = d[e], g = f.slice(0, 1).toUpperCase() + f.slice(1);
            a.prototype[f] = 0, a.prototype["get" + g] = b(f), a.prototype["set" + g] = c(f);
        }
    }, e = function(a, b, c, d) {
        function e() {
            b.addMonths(-a), d.months++, 12 === d.months && (d.years++, d.months = 0);
        }
        if (1 === a) for (;b > c; ) e(); else for (;c > b; ) e();
        d.months--, d.months *= a, d.years *= a;
    }, f = function(a, b, c) {
        var d = !1 == (b.isDaylightSavingTime() === c.isDaylightSavingTime());
        d && 1 === a ? b.addHours(-1) : d && b.addHours(1);
    }, g = function(a, b, c, d, g, h, i) {
        if (7 === arguments.length) this.set(a, b, c, d, g, h, i); else if (2 === arguments.length && arguments[0] instanceof Date && arguments[1] instanceof Date) {
            var j = arguments[0].clone(), k = arguments[1].clone(), l = j > k ? 1 : -1;
            this.dates = {
                start: arguments[0].clone(),
                end: arguments[1].clone()
            }, e(l, j, k, this), f(l, j, k);
            var m = k - j;
            if (0 !== m) {
    ...
    d(g, a), g.prototype.set = function(a, b, c, d, e, f, g) {
        this.setYears(a || this.getYears()), this.setMonths(b || this.getMonths()), this.setDays(c || this.getDays()), 
        this.setHours(d || this.getHours()), this.setMinutes(e || this.getMinutes()), this.setSeconds(f || this.getSeconds()), 
        this.setMilliseconds(g || this.getMilliseconds());
    }, Date.TimePeriod = g, "undefined" != typeof window && (window.TimePeriod = g);
}(), function(a) {
    a.Jcrop = function(b, c) {
        ...
        function n(a) {
            return function(b) {
                return J.disabled ? !1 : "move" !== a || J.allowMove ? (I = g(R), db = !0, j(a, h(b)), 
        ...
        function o(a, b, c) {
            ...
            d = c / a.height() * a.width()), bb = a.width() / d, cb = a.height() / e, a.width(d).height(e);
        }
        function p(a) {
            return {
                x: a.x * bb,
        ...
        function r(a) {
            ...
            var b = h(a);
            return lb.setPressed(b), nb.update(), ob.activateHandlers(s, q, "touch" === a.type.substring(0, 5)), 
            pb.watchKeys(), a.stopPropagation(), a.preventDefault(), !1;
        }
        function s(a) {
        ...
        function v(a, b) {
            ...
            if (!eb) {
                ...
                var s = function() {
                    return function() {
                        q += (100 - q) / r, k[0] = Math.round(d + q / 100 * m), k[1] = Math.round(e + q / 100 * n), 
                        k[2] = Math.round(f + q / 100 * o), k[3] = Math.round(g + q / 100 * p), q >= 99.8 && (q = 100), 
        ...
        function w(a) {
            x([ a[0] / bb, a[1] / cb, a[2] / bb, a[3] / cb ]), J.onSelect.call(qb, p(lb.getFixed())), 
            nb.enableHandles();
        }
        function x(a) {
        ...
        function F(a, b) {
            ...
            c.onload = function() {
                ...
                R.width(d).height(e), R.attr("src", a), V.attr("src", a), o(R, f, g), S = R.width(), 
                T = R.height(), V.width(S).height(T), hb.width(S + 2 * gb).height(T + 2 * gb), U.width(S).height(T), 
                mb.resize(S, T), C(), "function" == typeof b && b.call(qb);
            }, c.src = a;
        }
        function G(a, b, c) {
            var d = b || J.bgColor;
        ...
        function H(a) {
            ...
            ob.setCursor(J.allowSelect ? "crosshair" : "default"), nb.setCursor(J.allowMove ? "move" : "default"), 
            ...
            mb.refresh(), J.bgColor != ib && (G(J.shade ? mb.getShades() : U, J.shade ? J.shadeColor || J.bgColor : J.bgColor), 
            ib = J.bgColor), jb != J.bgOpacity && (jb = J.bgOpacity, J.shade ? mb.refresh() : nb.setBgOpacity(jb)), 
            Z = J.maxSize[0] || 0, $ = J.maxSize[1] || 0, _ = J.minSize[0] || 0, ab = J.minSize[1] || 0, 
        ...
        var kb = function() {
            ...
            return {
                createDragger: function(a) {
                    return function(b) {
                        return J.disabled ? !1 : "move" !== a || J.allowMove ? (I = g(R), db = !0, j(a, h(kb.cfilter(b)), !0), 
                        b.stopPropagation(), b.preventDefault(), !1) : !1;
                    };
                },
            ...
            function d(a) {
                var b = a[0], c = a[1];
                0 > m + b && (b -= b + m), 0 > n + c && (c -= c + n), p + c > T && (c += T - (p + c)), 
                o + b > S && (b += S - (o + b)), m += b, o += b, n += c, p += c;
            }
            function e(a) {
                var b = f();
                switch (a) {
            ...
            function f() {
                ...
                return 0 === g && (g = 10 * S), 0 === k && (k = 10 * T), e > t ? (b = p, c = s * e, 
                a = 0 > l ? m - c : c + m, 0 > a ? (a = 0, d = Math.abs((a - m) / e), b = 0 > q ? n - d : d + n) : a > S && (a = S, 
                d = Math.abs((a - m) / e), b = 0 > q ? n - d : d + n)) : (a = o, d = r / e, b = 0 > q ? n - d : n + d, 
                0 > b ? (b = 0, c = Math.abs((b - n) * e), a = 0 > l ? m - c : c + m) : b > T && (b = T, 
                c = Math.abs(b - n) * e, a = 0 > l ? m - c : c + m)), a > m ? (f > a - m ? a = m + f : a - m > g && (a = m + g), 
                b = b > n ? n + (a - m) / e : n - (a - m) / e) : m > a && (f > m - a ? a = m - f : m - a > g && (a = m - g), 
                b = b > n ? n + (m - a) / e : n - (m - a) / e), 0 > a ? (m -= a, a = 0) : a > S && (m -= a - S, 
                a = S), 0 > b ? (n -= b, b = 0) : b > T && (n -= b - T, b = T), j(h(m, n, a, b));
            }
            function g(a) {
                return a[0] < 0 && (a[0] = 0), a[1] < 0 && (a[1] = 0), a[0] > S && (a[0] = S), a[1] > T && (a[1] = T), 
            ...
            function i() {
                var a, b = o - m, c = p - n;
                return Z && Math.abs(b) > Z && (o = b > 0 ? m + Z : m - Z), $ && Math.abs(c) > $ && (p = c > 0 ? n + $ : n - $), 
                ab / cb && Math.abs(c) < ab / cb && (p = c > 0 ? n + ab / cb : n - ab / cb), _ / bb && Math.abs(b) < _ / bb && (o = b > 0 ? m + _ / bb : m - _ / bb), 
                0 > m && (o -= m, m -= m), 0 > n && (p -= n, n -= n), 0 > o && (m -= o, o -= o), 
                0 > p && (n -= p, p -= p), o > S && (a = o - S, m -= a, o -= a), p > T && (a = p - T, 
                n -= a, p -= a), m > S && (a = m - T, p -= a, n -= a), n > T && (a = n - T, p -= a, 
                n -= a), j(h(m, n, o, p));
            }
            function j(a) {
                return {
            ...
            function g() {
                m || (m = !0, n.insertBefore(R), c(), nb.setBgOpacity(1, 0, 1), V.hide(), h(J.shadeColor || J.bgColor, 1), 
                nb.isAwake() ? j(J.bgOpacity, 1) : j(1, 1));
            }
            function h(a, b) {
                G(l(), a, b);
            }
            function i() {
                m && (n.remove(), V.show(), m = !1, nb.isAwake() ? nb.setBgOpacity(J.bgOpacity, 1, 1) : (nb.setBgOpacity(1, 1, 1), 
                nb.disableHandles()), G(U, 0, 1));
            }
            function j(a, b) {
            ...
            function c(b, c) {
                ...
                return kb.support && d.bind("touchstart.jcrop", kb.createDragger(b)), X.append(d), 
                d;
            }
            function f(a) {
                var b = J.handleSize, d = c(a, B++).css({
            ...
            J.dragEdges && a.isArray(J.createDragbars) && h(J.createDragbars), a.isArray(J.createHandles) && j(J.createHandles), 
            J.drawBorders && a.isArray(J.createBorders) && i(J.createBorders), a(document).bind("touchstart.jcrop-ios", function(b) {
            ...
            return kb.support && G.bind("touchstart.jcrop", kb.createDragger("move")), W.append(G), 
            x(), {
                updateVisible: o,
                update: q,
                release: u,
            ...
            function e(a) {
                return a.preventDefault(), a.stopPropagation(), db && (db = !1, l(h(a)), nb.isAwake() && J.onSelect.call(qb, p(lb.getFixed())), 
            ...
            var k = function() {}, l = function() {}, m = J.trackDocument;
            ...
            function d(a, b, c) {
                J.allowMove && (lb.moveOffset([ b, c ]), nb.updateVisible(!0)), a.preventDefault(), 
                a.stopPropagation();
            }
            function e(a) {
            ...
            var f = a('<input type="radio" />').css({
                ...
                left: "-120px",
                width: "12px"
            }).addClass("jcrop-keymgr"), g = a("<div />").css({
                position: "absolute",
                overflow: "hidden"
            }).append(f);
    ...
    a.module("ngJcrop", []).constant("ngJcroptDefaultConfig", {
        ...
        }, b.previewImg = null, b.previewImgStyle = d.previewImgStyle, b.jcrop = null, b.coords = b.selection, 
        b.updateCurrentSizes = function(a) {
            ...
            f ? (b.imgStyle.width = d.jcrop.maxWidth, b.imgStyle.height = a.height / c) : g ? (b.imgStyle.height = d.jcrop.maxHeight, 
            b.imgStyle.width = a.width / e) : (b.imgStyle.height = a.height, b.imgStyle.width = a.width);
        }, b.getShrinkRatio = function() {
            var a = $("<img>").attr("src", b.mainImg[0].src)[0], c = a.width / d.jcrop.maxWidth, e = a.height / d.jcrop.maxHeight, f = a.width > d.jcrop.maxWidth && c > e;
            return f ? c : e;
        }, b.setSelection = function(c) {
            a.isArray(b.coords) || (b.coords = []), a.isArray(b.selection) || (b.selection = []), 
            b.coords[0] = c.x, b.coords[1] = c.y, b.coords[2] = c.x2, b.coords[3] = c.y2, b.coords[4] = c.w, 
            b.coords[5] = c.h;
            var d = b.getShrinkRatio();
            b.selection[0] = Math.round(c.x * d), b.selection[1] = Math.round(c.y * d), b.selection[2] = Math.round(c.x2 * d), 
            b.selection[3] = Math.round(c.y2 * d), b.selection[4] = Math.round(c.w * d), b.selection[5] = Math.round(c.h * d);
        }, b.showPreview = function(a) {
            if (b.selectionWatcher || b.$apply(function() {
                b.setSelection(a);
            }), b.thumbnail) {
                var c = 100 / a.w, d = 100 / a.h;
                b.previewImg.css({
            ...
            b.mainImg = $("<img>").addClass("ng-jcrop-image"), b.mainImg.on("load", b.onMainImageLoad), 
            b.mainImg.css({
                maxWidth: d.jcrop.maxWidth,
                maxHeight: d.jcrop.maxHeight
            }), b.mainImg.attr("src", a);
        }, b.init = function(a) {
            b.destroy(), b.initMainImage(a), b.imageWrapper = c.find(".ng-jcrop-image-wrapper"), 
            b.imageWrapper.empty().append(b.mainImg), b.previewImg = c.find(".ng-jcrop-thumbnail"), 
            ...
            d.thumbnail ? b.previewImg.show() : b.previewImg.hide();
        });
    } ]);
}(angular), function() {
    ...
    b["true"] = a, function(b, c) {
        ...
        H.createCoreModule("DomUtil", [], function(a, b) {
            ...
            function h(a, b, d) {
                ...
                var e = Q(a.startContainer, a.startOffset, b.endContainer, b.endOffset), f = Q(a.endContainer, a.endOffset, b.startContainer, b.startOffset);
                return d ? 0 >= e && f >= 0 : 0 > e && f > 0;
            }
            function i(a) {
                for (var b, d, e, f = c(a.range).createDocumentFragment(); d = a.next(); ) {
                    if (b = a.isPartiallySelectedSubtree(), d = d.cloneNode(!b), b && (e = a.getSubtreeIterator(), 
                    d.appendChild(i(e)), e.detach()), 10 == d.nodeType) throw new L("HIERARCHY_REQUEST_ERR");
                    f.appendChild(d);
                }
                return f;
            }
            function j(a, b, c) {
                ...
                for (var f, g; f = a.next(); ) if (a.isPartiallySelectedSubtree()) {
                    ...
                    if (g = a.getSubtreeIterator(), j(g, b, c), g.detach(), c.stop) return;
                } else for (d = I.createIterator(f); e = d.next(); ) if (b(e) === !1) return void (c.stop = !0);
            }
            function k(a) {
                for (var b; a.next(); ) a.isPartiallySelectedSubtree() ? (b = a.getSubtreeIterator(), 
                k(b), b.detach()) : a.remove();
            }
            function l(a) {
                for (var b, d, e = c(a.range).createDocumentFragment(); b = a.next(); ) {
                    ...
                    b.appendChild(l(d)), d.detach()) : a.remove(), 10 == b.nodeType) throw new L("HIERARCHY_REQUEST_ERR");
                    e.appendChild(b);
                }
                return e;
            }
            ...
            function o(a, b) {
                if (this.range = a, this.clonePartiallySelectedTextNodes = b, !a.collapsed) {
                    ...
                    this.sc === this.ec && M(this.sc) ? (this.isSingleCharacterDataNode = !0, this._first = this._last = this._next = this.sc) : (this._first = this._next = this.sc !== c || M(this.sc) ? S(this.sc, c, !0) : this.sc.childNodes[this.so], 
            ...
            function q(a, b) {
                if (db(a, b)) throw new L("INVALID_NODE_TYPE_ERR");
            }
            function r(a, b) {
            ...
            function t(a, b) {
                if (bb(a, !0) !== bb(b, !0)) throw new L("WRONG_DOCUMENT_ERR");
            }
            function u(a) {
                if (cb(a, !0)) throw new L("NO_MODIFICATION_ALLOWED_ERR");
            }
            function v(a, b) {
                if (!a) throw new L(b);
            }
            ...
            function y(a) {
                if (!x(a)) throw new Error("Range error: Range is not valid. This usually happens after DOM mutation. Range: (" + a.inspect() + ")");
            }
            function z(a, b) {
                y(a);
                var c = a.startContainer, d = a.startOffset, e = a.endContainer, f = a.endOffset, g = c === e;
                M(e) && f > 0 && f < e.length && R(e, f, b), M(c) && d > 0 && d < c.length && (c = R(c, d, b), 
                g ? (f -= d, e = c) : e == c.parentNode && f >= N(c) && f++, d = 0), a.setStartAndEnd(c, d, e, f);
            }
            function A(a) {
                y(a);
            ...
            function B(a) {
                a.START_TO_START = jb, a.START_TO_END = kb, a.END_TO_END = lb, a.END_TO_START = mb, 
                a.NODE_BEFORE = nb, a.NODE_AFTER = ob, a.NODE_BEFORE_AND_AFTER = pb, a.NODE_INSIDE = qb;
            }
            function C(a) {
                B(a), B(a.prototype);
            }
            function D(a, b) {
                return function() {
                    y(this);
                    var c, d, e = this.startContainer, g = this.startOffset, h = this.commonAncestorContainer, i = new o(this, !0);
                    e !== h && (c = S(e, h, !0), d = f(c), e = d.node, g = d.offset), j(i, u), i.reset();
                    var k = a(i);
                    return i.detach(), b(this, e, g, e, g), k;
                };
            }
            function E(c, d) {
                function g(a, b) {
                ...
                var j = function() {};
                j.prototype = a.rangePrototype, c.prototype = new j(), J.extend(c.prototype, {
                    setStart: function(a, b) {
                        q(a, !0), s(a, b), h(this, a, b);
                    },
                    setEnd: function(a, b) {
                        q(a, !0), s(a, b), i(this, a, b);
                    },
                    ...
                    canSurroundContents: function() {
                        y(this), u(this.startContainer), u(this.endContainer);
                        var a = new o(this, !0), c = a._first && b(a._first, this) || a._last && b(a._last, this);
                        return a.detach(), !c;
                    },
                    ...
                    normalizeBoundaries: function() {
                        ...
                        var a, b = this.startContainer, c = this.startOffset, e = this.endContainer, f = this.endOffset, g = function(a) {
                            var b = a.nextSibling;
                            b && b.nodeType == a.nodeType && (e = a, f = a.length, a.appendData(b.data), X(b));
                        }, h = function(a) {
                            var d = a.previousSibling;
                            if (d && d.nodeType == a.nodeType) {
                                b = a;
                                var g = a.length;
                                if (c = d.length, a.insertData(0, d.data), X(d), b == e) f += c, e = b; else if (e == a.parentNode) {
                                    var h = N(a);
                                    f == h ? (e = a, f = g) : f > h && f--;
                                }
                            }
                        }, i = !0;
                        if (M(e)) f == e.length ? g(e) : 0 == f && (a = e.previousSibling, a && a.nodeType == e.nodeType && (f = a.length, 
                        b == e && (i = !1), a.appendData(e.data), X(e), e = a)); else {
                            if (f > 0) {
                        ...
                        if (i) {
                            if (M(b)) 0 == c ? h(b) : c == b.length && (a = b.nextSibling, a && a.nodeType == b.nodeType && (e == a && (e = b, 
                            f += b.length), b.appendData(a.data), X(a))); else if (c < b.childNodes.length) {
                    ...
                    collapseToPoint: function(a, b) {
                        q(a, !0), s(a, b), this.setStartAndEnd(a, b);
                    }
                }), C(c);
            }
            function F(a) {
            ...
            function G(a, b, c, d, e) {
                a.startContainer = b, a.startOffset = c, a.endContainer = d, a.endOffset = e, a.document = I.getDocument(b), 
                F(a);
            }
            function H(a) {
                this.startContainer = a, this.startOffset = 0, this.endContainer = a, this.endOffset = 0, 
                this.document = a, F(this);
            }
            var I = a.dom, J = a.util, K = I.DomPosition, L = a.DOMException, M = I.isCharacterDataNode, N = I.getNodeIndex, O = I.isOrIsAncestorOf, P = I.getDocument, Q = I.comparePoints, R = I.splitDataNode, S = I.getClosestAncestorIn, T = I.getNodeLength, U = I.arrayContains, V = I.getRootContainer, W = a.features.crashyTextNodes, X = I.removeNode;
            o.prototype = {
                _current: null,
                _next: null,
                _first: null,
                ...
                next: function() {
                    ...
                    return a && (this._next = a !== this._last ? a.nextSibling : null, M(a) && this.clonePartiallySelectedTextNodes && (a === this.ec && (a = a.cloneNode(!0)).deleteData(this.eo, a.length - this.eo), 
                ...
                getSubtreeIterator: function() {
                    ...
                    if (this.isSingleCharacterDataNode) a = this.range.cloneRange(), a.collapse(!1); else {
                        ...
                        var b = this._current, d = b, e = 0, f = b, g = T(b);
                        O(b, this.sc) && (d = this.sc, e = this.so), O(b, this.ec) && (f = this.ec, g = this.eo), 
                        G(a, d, e, f, g);
                    }
            ...
            var Y = [ 1, 3, 4, 5, 7, 8, 10 ], Z = [ 2, 9, 11 ], $ = [ 5, 6, 10, 12 ], _ = [ 1, 3, 4, 5, 7, 8, 10, 11 ], ab = [ 1, 3, 4, 5, 7, 8 ], bb = p([ 9, 11 ]), cb = p($), db = p([ 6, 10, 12 ]), eb = document.createElement("style"), fb = !1;
            try {
                eb.innerHTML = "<b>x</b>", fb = 3 == eb.firstChild.nodeType;
            } catch (gb) {}
            a.features.htmlParsingConforms = fb;
            var hb = fb ? function(a) {
                var b = this.startContainer, c = P(b);
                if (!b) throw new L("INVALID_STATE_ERR");
                var d = null;
                return 1 == b.nodeType ? d = b : M(b) && (d = I.parentElement(b)), d = null === d || "HTML" == d.nodeName && I.isHtmlNamespace(P(d).documentElement) && I.isHtmlNamespace(d) ? c.createElement("body") : d.cloneNode(!1), 
                d.innerHTML = a, I.fragmentFromNodeChildren(d);
            } : function(a) {
                var b = c(this), d = b.createElement("body");
                return d.innerHTML = a, I.fragmentFromNodeChildren(d);
            }, ib = [ "startContainer", "startOffset", "endContainer", "endOffset", "collapsed", "commonAncestorContainer" ], jb = 0, kb = 1, lb = 2, mb = 3, nb = 0, ob = 1, pb = 2, qb = 3;
            J.extend(a.rangePrototype, {
                compareBoundaryPoints: function(a, b) {
                    y(this), t(this.startContainer, b.startContainer);
                    var c, d, e, f, g = a == mb || a == jb ? "start" : "end", h = a == kb || a == jb ? "start" : "end";
                    return c = this[g + "Container"], d = this[g + "Offset"], e = b[h + "Container"], 
                    f = b[h + "Offset"], Q(c, d, e, f);
                },
                insertNode: function(a) {
                    if (y(this), r(a, _), u(this.startContainer), O(a, this.startContainer)) throw new L("HIERARCHY_REQUEST_ERR");
                ...
                cloneContents: function() {
                    ...
                    if (this.startContainer === this.endContainer && M(this.startContainer)) return a = this.startContainer.cloneNode(!0), 
                    a.data = a.data.slice(this.startOffset, this.endOffset), b = c(this).createDocumentFragment(), 
                    b.appendChild(a), b;
                    var d = new o(this, !0);
                    return a = i(d), d.detach(), a;
                },
                canSurroundContents: function() {
                    y(this), u(this.startContainer), u(this.endContainer);
                    var a = new o(this, !0), c = a._first && b(a._first, this) || a._last && b(a._last, this);
                ...
                surroundContents: function(a) {
                    if (r(a, ab), !this.canSurroundContents()) throw new L("INVALID_STATE_ERR");
                ...
                cloneRange: function() {
                    y(this);
                    for (var a, b = new H(c(this)), d = ib.length; d--; ) a = ib[d], b[a] = this[a];
                    return b;
                },
                toString: function() {
                    y(this);
                ...
                compareNode: function(a) {
                    y(this);
                    var b = a.parentNode, c = N(a);
                    if (!b) throw new L("NOT_FOUND_ERR");
                    var d = this.comparePoint(b, c), e = this.comparePoint(b, c + 1);
                    return 0 > d ? e > 0 ? pb : nb : e > 0 ? ob : qb;
                },
                comparePoint: function(a, b) {
                    return y(this), v(a, "HIERARCHY_REQUEST_ERR"), t(a, this.startContainer), Q(a, b, this.startContainer, this.startOffset) < 0 ? -1 : Q(a, b, this.endContainer, this.endOffset) > 0 ? 1 : 0;
                },
                createContextualFragment: hb,
                toHtml: function() {
                    return A(this);
                },
                intersectsNode: function(a, b) {
                    if (y(this), V(a) != d(this)) return !1;
                    var c = a.parentNode, e = N(a);
                    if (!c) return !0;
                    var f = Q(c, e, this.endContainer, this.endOffset), g = Q(c, e + 1, this.startContainer, this.startOffset);
                    return b ? 0 >= f && g >= 0 : 0 > f && g > 0;
                },
                isPointInRange: function(a, b) {
                    return y(this), v(a, "HIERARCHY_REQUEST_ERR"), t(a, this.startContainer), Q(a, b, this.startContainer, this.startOffset) >= 0 && Q(a, b, this.endContainer, this.endOffset) <= 0;
                },
                ...
                intersection: function(a) {
                    if (this.intersectsRange(a)) {
                        var b = Q(this.startContainer, this.startOffset, a.startContainer, a.startOffset), c = Q(this.endContainer, this.endOffset, a.endContainer, a.endOffset), d = this.cloneRange();
                ...
                containsNode: function(a, b) {
                    return b ? this.intersectsNode(a, !1) : this.compareNode(a) == qb;
                },
                ...
                getBookmark: function(b) {
                    var d = c(this), e = a.createRange(d);
            ...
            if (a.features.implementsDomRange && !function() {
                ...
                var l = function(a) {
                    ...
                    for (var m, n, o, p, q, r = c ? "StartToStart" : "StartToEnd", s = f && f.containerElement == i ? f.nodeIndex : 0, t = i.childNodes.length, u = t, v = u; v == t ? i.appendChild(l) : i.insertBefore(l, i.childNodes[v]), 
                    h.moveToElementText(l), m = h.compareEndPoints(r, a), 0 != m && s != u; ) {
                        if (-1 == m) {
                            if (u == s + 1) break;
                            s = v;
                        } else u = u == s + 1 ? s : v;
            ...
            function t(a, b) {
                for (var c, d, e = bb.length; e--; ) if (c = bb[e], d = c.selection, "deleteAll" == b) s(d); else if (c.win == a) return "delete" == b ? (bb.splice(e, 1), 
                !0) : d;
            ...
            a.getSelection = cb, D.createAliasForDeprecatedMethod(a, "getIframeSelection", "getSelection");
            var db = r.prototype;
            if (!Q && U && D.areHostMethods(R, [ "removeAllRanges", "addRange" ])) {
                ...
                db.addRange = W ? function(b, d) {
                    if (_ && P && this.docSelection.type == K) q(this, b); else if (c(d) && V) eb(this, b); else {
                        var e;
            ...
            !Q && U && J.implementsDomRange ? (hb = g, db.isBackward = function() {
                ...
                t(null, "deleteAll");
            }, r.inspect = x, r.isDirectionBackward = c, a.Selection = r, a.selectionPrototype = db, 
    ...
    b["true"] = a, function(a, b) {
        ...
        function f(a, c) {
            function d(a, d, f, h) {
                if (d = b.lowercase(d), A[d]) for (;k.last() && B[k.last()]; ) e("", k.last());
            ...
            for (k.last = function() {
                ...
                }), e("", k.last())) : (0 === a.indexOf("<!--") ? (f = a.indexOf("--", 4), f >= 0 && a.lastIndexOf("-->", f) === f && (c.comment && c.comment(a.substring(4, f)), 
                ...
                h = !1)) : p.test(a) && (i = a.match(m), i ? (i[4] && (a = a.substring(i[0].length), 
                i[0].replace(m, d)), h = !1) : (j += "<", a = a.substring(1))), h && (f = a.indexOf("<"), 
                j += 0 > f ? a : a.substring(0, f), a = 0 > f ? "" : a.substring(f), c.chars && c.chars(g(j)))), 
                a == u) throw l("badparse", "The sanitizer was unable to parse the following block of html: {0}", a);
                u = a;
            }
            e();
        }
        function g(a) {
            if (!a) return "";
            var b = K.exec(a), c = b[1], d = b[3], e = b[2];
            return e && (J.innerHTML = e.replace(/</g, "&lt;"), e = "textContent" in J ? J.textContent : J.innerText), 
            c + e + d;
        }
        function h(a) {
        ...
        function i(a) {
            ...
            return b.forEach(d, function(a) {
                var d = a.split(":");
                if (2 == d.length) {
                    var e = L(b.lowercase(d[0])), a = L(b.lowercase(d[1]));
            ...
            return {
                start: function(a, f, g) {
                    a = b.lowercase(a), !d && D[a] && (d = a), d || E[a] !== !0 || (e("<"), e(a), b.forEach(f, function(d, g) {
                        ...
                        ("style" === k && "" !== (d = i(d)) || j(a, f, k, d) || I[k] === !0 && (F[k] !== !0 || c(d, l))) && (e(" "), 
                        e(g), e('="'), e(h(d)), e('"'));
                    }), e(g ? "/>" : ">"));
                },
                end: function(a) {
    ...
    q.constant("taRegisterTool", b), q.value("taTools", r), q.config([ function() {
        ...
        return {
            ...
            link: function(g, h, i) {
                ...
                var j = function(b, c) {
                    var d;
                    if (d = angular.element(b && b.display ? b.display : "<button type='button'>"), 
    ...
    a("insertImage", {
        ...
        onElementSelect: {
            ...
            action: function(a, d, e) {
                ...
                var h = angular.element('<div class="btn-group pull-right">'), i = angular.element('<button type="button" class="btn btn-default btn-sm btn-small" tabindex="-1" unselectable="on" title="' + c.editLink.reLinkButton.tooltip + '"><i class="fa fa-edit icon-edit"></i></button>');
                i.on("click", function(a) {
                    a.preventDefault();
    ...
    function D(a, b) {
        ...
        a(hb).on(function(a) {
            var b, c = Y(e), d = ab(c), f = Z(e);
            f && (b = bb(Y(f)), b[d] = a);
        }), a(ib).on(function() {
            var a, b = Y(e), d = ab(b), f = Z(e);
    ...
    function I(b, c, d, e, g, h, i) {
        ...
        var k = b(nb).emit, l = b(jb).emit, m = 0, n = !0;
        b(pb).on(function() {
    ...
    function K(a) {
        ...
        var h = a(fb).emit, i = a(gb).emit, j = a(lb).emit, k = a(kb).emit, l = {};
    ...
    function P(a, b) {
        ...
        var p, r = /^(node|path):./, s = a(kb), t = a(ib).emit, u = a(hb).emit, v = j(function(b, c) {
            if (p[b]) i(c, p[b]); else {
                var e = a(b), f = c[0];
    ...
    var T = j(function(a, b) {
    ...
    }(), ab = h("key"), bb = h("node"), cb = {}, db = _(function(a, b, c, e, f) {
        function h(a, b) {
        ...
        var y = 1, z = 2, A = 3, B = g(ab, Y), C = g(bb, Y), D = U(u(a, $(j, i, h, k)), u(b, $(m)), u(c, $()), u(e, $(j, o)), u(f, $(p)), function(a) {
    ...
    }), eb = 1, fb = eb++, gb = eb++, hb = eb++, ib = eb++, jb = "fail", kb = eb++, lb = eb++, mb = "start", nb = "data", ob = "end", pb = eb++, qb = eb++, rb = eb++, sb = eb++;
    S.drop = function() {
        return S.drop;
